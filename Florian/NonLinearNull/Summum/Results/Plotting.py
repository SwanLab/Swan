...
axes[0].plot(iterT[0:51], CompT[0:51], color='b', label='1 geo it')
axes[0].plot(iterT5[0:51], CompT5[0:51], color='r', label='5 geo it')
axes[0].legend()
axes[0].set_xlabel('Iter')
axes[0].set_ylabel('Compliance')
axes[0].grid(True, linestyle='--', alpha=0.6)

axes[1].plot(iterT[0:51], VT[0:51], color='b', label='1 geo it')
axes[1].plot(iterT5[0:51], VT5[0:51], color='r', label='5 geo it')
axes[1].legend()
axes[1].set_xlabel('Iter')
axes[1].set_ylabel('Volume constraint')
axes[1].grid(True, linestyle='--', alpha=0.6)

axes[2].plot(iterT[0:51], per[0:51], color='b', label='1 geo it')
axes[2].plot(iterT5[0:51], per5[0:51], color='r', label='5 geo it')
axes[2].legend()
