...
axes[0].plot(iter5, Comp5, color='r', label='5 geo it')
axes[0].legend()
...
axes[1].plot(iter5, Vol5, color='r', label='5 geo it')
axes[1].legend()
axes[1].set_xlabel('Iter')
axes[1].set_ylabel('Volume constraint')
axes[1].grid(True, linestyle='--', alpha=0.6)

axes[2].plot(iter1, T1, color='b', label='1 geo it')
axes[2].plot(iter5, T5, color='r', label='5 geo it')
axes[2].legend()
