...
def FunctionCase07(maxItj,stepHJ,No,maxIter):
    ...
    class TO_problem(EuclideanOptimizable):
        ...
        def J(self, x):
            runner = FreeFemRunner(path+"07_Cost.edp")
        ...
        def dH(self, x):
            runner = FreeFemRunner(path+"07_ConstraintEqGradient.edp")
    ...
    runner = FreeFemRunner(path+"07_BoundaryRefinement.edp")
    ...
    runner = FreeFemRunner(path+"07_VolFracComputer.edp")
    ...
    while normdx > params['tol'] and it <= params['maxit']:
        ...
        while itj<=maxItj:
            ...
            # Update step
            g = AJ*xiJ+AC*xiC
            runner = FreeFemRunner(path+"07_HJ.edp")
