classdef ExampleCylinderBimaterialSIMPP3 < handle
    ...
    methods (Access = public)
        ...
        function obj = ExampleCylinderBimaterialSIMPP3()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'SIMPALL3DPaper/BimaterialCase/MonitoringExampleBimatCylSIMPP3.fig');
            obj.designVariable.fun.print('SIMPALL3DPaper/BimaterialCase/ExampleBimatCylSIMPP3');
        end
