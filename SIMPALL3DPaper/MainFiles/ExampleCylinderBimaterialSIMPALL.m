classdef ExampleCylinderBimaterialSIMPALL < handle
    ...
    methods (Access = public)
        ...
        function obj = ExampleCylinderBimaterialSIMPALL()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'SIMPALL3DPaper/BimaterialCase/MonitoringExampleBimatCylSIMPALL.fig');
            obj.designVariable.fun.print('SIMPALL3DPaper/BimaterialCase/ExampleBimatCylSIMPALL');
        end
