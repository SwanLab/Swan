classdef tempFetiDPElasticityEdgeAverage < handle
    ...
    methods (Access = public)
        ...
        % 1. CONSTRUCTOR
        % -----------------------------------------------------------------
        function obj = tempFetiDPElasticityEdgeAverage(globalMesh, subMeshes, stiffness, forces, tol, dofsNode, boundaryConditions, localToGlobalMaps)
