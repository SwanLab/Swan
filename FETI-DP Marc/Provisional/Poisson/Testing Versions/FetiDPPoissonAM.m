classdef FetiDPPoissonAM < handle
    ...
    properties (Access = private)
        ...
        nodeTol         
        numSubdomains   
        dirichletDofs    % NOU: Rep i guarda les BCs de l'orquestrador
    ...
    methods (Access = public)
        ...
        function obj = FetiDPPoissonAM(globalMesh, subMeshes, stiffness, forces, tol, dirDofs)
