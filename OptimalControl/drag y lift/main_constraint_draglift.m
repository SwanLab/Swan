function main_constraint_draglift
    ...
    ub = [15 deg2rad(11)]; % Upper bounds for the control
    ...
    Cl = @(alpha) Cl0 + Clalpha*rad2deg(alpha);
    ...
    constraint = @(u) groundConstraint(u, g, t0, v0, x1_0, x2_0, gamma0, D, N, m, L);
...
function [ceq] = groundConstraint(u, g, t0, v0, x1_0, x2_0, gamma0, D, N, m, L)
    y0 = [x1_0 x2_0 v0 gamma0]';
    tf = u(1);
    t_span = linspace(t0, tf, N);
    alpha = u(2:N+1);
