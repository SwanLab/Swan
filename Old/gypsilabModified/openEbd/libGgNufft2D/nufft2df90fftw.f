...
c
      do k2 = 0, nf1*nf2-1, nf1 
         if (iflag .ge. 0) then
            call zfftb(nf1,fw(2*k2),fw(iw15))
         else
            call zfftf(nf1,fw(2*k2),fw(iw15))
         endif
      enddo
c
      do k1 = -ms/2, (ms-1)/2
         ...
         enddo
         if (iflag .ge. 0) then
           call zfftb(nf2,fw(2*nw1),fw(iw16))
         else
           call zfftf(nf2,fw(2*nw1),fw(iw16))
         endif
      enddo
c
      do k1 = -ms/2, (ms-1)/2
...
c
      do k2 = -jb2-nspread, jb2+nspread
         ii = (nf2/2+k2)*nf1
         if (iflag .ge. 0) then
            call zfftb(nf1,fw(2*ii),fw(iw15))
         else
            call zfftf(nf1,fw(2*ii),fw(iw15))
         endif
