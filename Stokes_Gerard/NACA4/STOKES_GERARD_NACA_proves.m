...
%fH = @(x) -min([((x(1,:,:)-1.500000).^2 + (x(2,:,:)-0.500000).^2 - 0.200000.^2),((x(1,:,:)-0.400000).^2 + (x(2,:,:)-0.500000).^2 - 0.300000.^2),((x(1,:,:)-0.900000).^2 + (x(2,:,:)-0.500000).^2 - 0.200000.^2),((x(1,:,:)-0.600000).^2 + (x(2,:,:)-0.600000).^2 - 0.200000.^2)]);
%fH = @(x) -min(min(min(((x(1,:,:)-x_p(1)).^2+(x(2,:,:)-y_c(1)).^2-r(1)^2),((x(1,:,:)-x_p(2)).^2+(x(2,:,:)-y_c(2)).^2-r(2)^2)),((x(1,:,:)-x_p(3)).^2+(x(2,:,:)-y_c(3)).^2-r(3)^2)),((x(1,:,:)-x_p(4)).^2+(x(2,:,:)-y_c(4)).^2-r(4)^2));
