...
s.fileName = 'AlbertTFG files/comparisons/k case 2/100x100/K_data case 2 100x100.csv';
...
s.optimizerParams.maxEpochs = 10^8; % 1000 is the best option, but we use 10 to pass the tutorial quickly
