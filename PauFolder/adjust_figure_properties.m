...
%   Assignment: Numerical solution of the incompressible Navier-Stokes equations
%   Authors: Pau Climent, Liah Polanco, Jordi Vàzquez
%   Date: 21/10/2024
%----------------------------------------------------------------------------------------------------
...
%               for export.
    ...
    if ~isempty(legend_handle)
        set(legend_handle, 'Box', 'off');              % Turn off the legend box
    end
