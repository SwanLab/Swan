classdef RaviartThomasElement3D < handle
    ...
    0.375, 0.375, 0.25;
            ...
            for s = 1:ndof
                ...
                quiver3(nodes(:,1),nodes(:,2),nodes(:,3),double(X(:,1)),double(X(:,2)),double(X(:,3)),2.5,'k');
    ...
    methods (Access = private)
        ...
        function LHS = applyLinearForm(obj)
            ...
            LHS(1) = obj.planeIntegral(Nn(1),v(2,:),v(3,:),v(4,:))/4*sqrt(3);
            LHS(2) = obj.planeIntegral(Nn(2),v(3,:),v(1,:),v(4,:))/4;
            LHS(3) = obj.planeIntegral(Nn(3),v(1,:),v(2,:),v(4,:))/4;
            LHS(4) = obj.planeIntegral(Nn(4),v(1,:),v(2,:),v(3,:))/4;
        end
