classdef LHSintegrator_CurlNCurlN_N < LHSintegrator
    ...
    methods (Access = protected)
        ...
        function lhs = computeElementalLHS(obj)
            ...
            curl = obj.fun.computeCurlShapeFunctions(obj.quadrature);
                    ...
                    for jnode= 1:nNodE
                        for iunkn= 1:nDimf
                            for junkn= 1:nDimf
                                ...
                                dvol = dVolu(:,igauss);
                                CurlNi = curl(inode,:,igauss);
                                CurlNj = curl(jnode,:,igauss);
                                v = CurlNi.*CurlNj;
