classdef DensityGripper < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityGripper()
            ...
            saveas(gcf,'Paper/Reference/MonitoringDensityGripper.fig');
            save('Paper/Reference/DensityGripper.mat','d');
            obj.designVariable.fun.print('Paper/Reference/DensityGripperfValues');
        end
