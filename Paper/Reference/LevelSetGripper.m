classdef LevelSetGripper < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetGripper()
            ...
            saveas(gcf,'Paper/Reference/MonitoringLevelSetGripper.fig');
            save('Paper/Reference/LevelSetGripper.mat','d');
            obj.designVariable.fun.print('Paper/Reference/LevelSetGripperfValues');
        end
