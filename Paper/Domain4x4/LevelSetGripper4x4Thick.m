classdef LevelSetGripper4x4Thick < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetGripper4x4Thick(hTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain4x4/MonitoringLevelSetGripper4x4Thick',num2str(hTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Domain4x4/LevelSetGripper4x4Thick',num2str(hTar),'fValues']);
        end
