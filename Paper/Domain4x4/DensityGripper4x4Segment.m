classdef DensityGripper4x4Segment < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityGripper4x4Segment(pRelTar)
            ...
            saveas(gcf,['Paper/Global/MonitoringDensityGripper4x4Segment',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/DensityGripper4x4Segment',num2str(pRelTar),'fValues']);
        end
