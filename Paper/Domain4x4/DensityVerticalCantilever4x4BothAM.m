classdef DensityVerticalCantilever4x4BothAM < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityVerticalCantilever4x4BothAM()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'Paper/Domain4x4/MonitoringDensityVerticalCantilever4x4BothAM.fig');
            obj.designVariable.fun.print('Paper/Domain4x4/DensityVerticalCantilever4x4BothAMfValues');
        end
