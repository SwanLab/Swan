classdef DensityVerticalCantilever4x4Segment < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityVerticalCantilever4x4Segment(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain4x4/MonitoringDensityVerticalCantilever4x4Segment',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Domain4x4/DensityVerticalCantilever4x4Segment',num2str(pRelTar),'fValues']);
        end
