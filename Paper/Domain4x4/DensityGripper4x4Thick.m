classdef DensityGripper4x4Thick < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityGripper4x4Thick(hTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain4x4/MonitoringDensityGripper4x4Thick',num2str(hTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Domain4x4/DensityGripper4x4Thick',num2str(hTar),'fValues']);
        end
