classdef DensityOverhangBenchmark6x6 < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityOverhangBenchmark6x6()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain6x6/MonitoringDensityOverhangBenchmark6x6Thick.fig']);
            obj.designVariable.fun.print(['Paper/Domain6x6/DensityOverhangBenchmark6x6ThickfValues']);
        end
    ...
    methods (Access = private)
        ...
        function createOverhangConstraint(obj)
            ...
            x0 = 3.*repmat([1/12,1/4,5/12,7/12,3/4,11/12],[1,6]);
