classdef LevelSetVerticalCantileverGlobalSegment < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetVerticalCantileverGlobalSegment(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringLevelSetVerticalCantileverGlobalSegment',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/LevelSetVerticalCantileverGlobalSegment',num2str(pRelTar),'fValues']);
        end
