classdef LevelSetGripperGlobalSegment < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetGripperGlobalSegment(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringLevelSetGripperGlobalSegment',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/LevelSetGripperGlobalSegment',num2str(pRelTar),'fValues']);
        end
