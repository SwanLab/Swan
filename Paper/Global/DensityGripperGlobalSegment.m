classdef DensityGripperGlobalSegment < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityGripperGlobalSegment(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringDensityGripperGlobalSegment',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/DensityGripperGlobalSegment',num2str(pRelTar),'fValues']);
        end
