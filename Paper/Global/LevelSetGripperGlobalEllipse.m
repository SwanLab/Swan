classdef LevelSetGripperGlobalEllipse < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetGripperGlobalEllipse(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringLevelSetGripperGlobalEllipse',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/LevelSetGripperGlobalEllipse',num2str(pRelTar),'fValues']);
        end
