classdef LevelSetVerticalCantileverGlobalCircle < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetVerticalCantileverGlobalCircle(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringLevelSetVerticalCantileverGlobalCircle',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/LevelSetVerticalCantileverGlobalCircle',num2str(pRelTar),'fValues']);
        end
