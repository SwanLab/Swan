classdef DensityVerticalCantileverGlobalEllipse < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityVerticalCantileverGlobalEllipse(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringDensityVerticalCantileverGlobalEllipse',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/DensityVerticalCantileverGlobalEllipse',num2str(pRelTar),'fValues']);
        end
