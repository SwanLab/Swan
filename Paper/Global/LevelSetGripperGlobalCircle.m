classdef LevelSetGripperGlobalCircle < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetGripperGlobalCircle(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringLevelSetGripperGlobalCircle',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/LevelSetGripperGlobalCircle',num2str(pRelTar),'fValues']);
        end
