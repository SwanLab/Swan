classdef LevelSetVerticalCantileverGlobalEllipse < handle
    ...
    methods (Access = public)
        ...
        function obj = LevelSetVerticalCantileverGlobalEllipse(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Global/MonitoringLevelSetVerticalCantileverGlobalEllipse',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Global/LevelSetVerticalCantileverGlobalEllipse',num2str(pRelTar),'fValues']);
        end
