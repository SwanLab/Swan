classdef DensityVerticalCantilever2x2Circle < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityVerticalCantilever2x2Circle(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain2x2/MonitoringDensityVerticalCantilever2x2Circle',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Domain2x2/DensityVerticalCantilever2x2Circle',num2str(pRelTar),'fValues']);
        end
