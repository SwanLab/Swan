classdef DensityVerticalCantilever2x2Ellipse < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityVerticalCantilever2x2Ellipse(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain2x2/MonitoringDensityVerticalCantilever2x2Ellipse',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['Paper/Domain2x2/DensityVerticalCantilever2x2Ellipse',num2str(pRelTar),'fValues']);
        end
    ...
    methods (Access = private)
        ...
        function createPerimeter(obj,p)
            ...
            s.minEpsilon = 3*h;
            s.value0 = 1;
            s.target = (14.9756/4)*p;

            x0 = [0.25,0.75,0.25,0.75];
            y0 = [1.50,1.50,0.50,0.50];
            for i = 1:length(x0)
