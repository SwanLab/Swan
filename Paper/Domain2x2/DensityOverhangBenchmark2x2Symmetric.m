classdef DensityOverhangBenchmark2x2Symmetric < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityOverhangBenchmark2x2Symmetric()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain2x2/MonitoringDensityOverhangBenchmark2x2Sym.fig']);
            obj.designVariable.fun.print(['Paper/Domain2x2/DensityOverhangBenchmark2x2SymfValues']);
        end
    ...
    methods (Access = private)
        ...
        function createMesh(obj)
            obj.mesh = TriangleMesh(1.5,1,120,80);
        end
        ...
        function uMesh = createBaseDomainOverhang(obj,x0,y0)
            s.type             = 'Rectangle';
            s.xCoorCenter      = x0;
            s.yCoorCenter      = y0;
            s.xSide            = 1.5/2;
        ...
        function bc = createBoundaryConditions(obj)
            ...
            isDir   = @(coor)  coor(:,2)==0;
            isDir2  = @(coor)  coor(:,1)==0;
            isForce = @(coor)  coor(:,2)==yMax & coor(:,1)<=(0.15/2);
