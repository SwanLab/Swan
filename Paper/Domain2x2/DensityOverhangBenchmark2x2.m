classdef DensityOverhangBenchmark2x2 < handle
    ...
    methods (Access = public)
        ...
        function obj = DensityOverhangBenchmark2x2()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['Paper/Domain2x2/MonitoringDensityOverhangBenchmark2x2.fig']);
            obj.designVariable.fun.print(['Paper/Domain2x2/DensityOverhangBenchmark2x2fValues']);
        end
