...
files = {'Monitoring_0_90_LevelSet.fig', 'Monitoring_0_LevelSet.fig', 'Monitoring_45_LevelSet.fig'};
...
xlabel('Iteration')
legend('Level Set 0/90ºº', 'Level Set 0º','Level Set 45º');
title('Compliance comparison between orientations')
...
xlabel('Iteration')
legend('Level Set 0/90ºº', 'Level Set 0º','Level Set 45º');
title('Volume Constraint comparison between orientations')