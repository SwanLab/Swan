classdef Anisotropic_0_90_Density_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_0_90_Density_3D()
            obj.init()
            obj.createMesh();
            ...
            figure(2);
            saveas(gcf,'Monitoring_0_90_3D_Density.fig');
            obj.designVariable.fun.print('fValues_0_90_3D_Density_MBB');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = false;
            s.gifName = 'Gif_0_90_3D_Density_MBB';
            s.printing = true;
            s.printName = 'Results_0_90_3D_Density_MBB';
