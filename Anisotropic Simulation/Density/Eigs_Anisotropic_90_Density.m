classdef Eigs_Anisotropic_90_Density < handle
    ...
    methods (Access = public)
        ...
        function obj = Eigs_Anisotropic_90_Density()
            ...
            obj.designVariable.fun.print('fValues_90_Density_Eigs_Lambda_1minus3');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = true;
            s.gifName = 'Eigs_Gif_90_Density_Lambda_1minus3';
            s.printing = false;
            s.printName = 'Eigs_Results_90_Density_Lambda_1minus3';
