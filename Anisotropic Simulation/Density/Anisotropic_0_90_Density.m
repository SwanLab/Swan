classdef Anisotropic_0_90_Density < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_0_90_Density()
            obj.init()
            obj.createMesh();
            ...
            %saveas(gcf,'Monitoring_0_90_Density.fig');
            obj.designVariable.fun.print('fValues_0_90_Density');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0_90';
            s.gif = true;
            s.gifName = 'Gif_0_90_Density';
            s.printing = false;
            s.printName = 'Results_0_90_Density';
