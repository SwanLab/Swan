classdef Eigs_Anisotropic_0_Density < handle
    ...
    methods (Access = public)
        ...
        function obj = Eigs_Anisotropic_0_Density()
            obj.lambda1min = 1; % To change with the 50 Hz minimum
            obj.init()
            obj.createMesh();
            ...
            obj.designVariable.fun.print('fValues_0_Density_Eigs');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = true;
            s.gifName = 'Eigs_Gif_0_Density';
            s.printing = false;
            s.printName = 'Eigs_Results_0_Density';
