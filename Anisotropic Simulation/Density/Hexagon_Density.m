classdef Hexagon_Density < handle
    ...
    methods (Access = public)
        ...
        function obj = Hexagon_Density()
            ...
            figure(2)
            saveas(gcf,'Monitoring_Hexagon_Density.fig');
            obj.designVariable.fun.print('fValues_Hexagon_Density');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = true;
            s.gifName = 'Gif_Hexagon_Density';
            s.printing = false;
            s.printName = 'Results_Hexagon_Density';
