classdef Anisotropic_45_Density < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_45_Density()
            obj.init()
            obj.createMesh();
            ...
            obj.designVariable.fun.print('fValues_45_Density_MBB');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '45';
            s.gif = true;
            s.gifName = 'Gif_45_Density_MBB';
            s.printing = false;
            s.printName = 'Results_45_Density_MBB';
