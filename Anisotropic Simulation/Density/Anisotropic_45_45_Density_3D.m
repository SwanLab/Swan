classdef Anisotropic_45_45_Density_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_45_45_Density_3D()
            obj.init()
            obj.createMesh();
            ...
            figure(2);
            saveas(gcf,'Monitoring_45_45_3D_Density.fig');
            obj.designVariable.fun.print('fValues_45_45_3D_Density_MBB');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = false;
            s.gifName = 'Gif_45_45_3D_Density_MBB';
            s.printing = true;
            s.printName = 'Results_45_45_3D_Density_MBB';
