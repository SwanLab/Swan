    ...
    methods (Access = public, Static)
        ...
        function tensor = create(cParams)
            ...
            switch cParams
                ...
                case '45_3D'
                    tensor = [0.1357  0.0749  0.0565   -0.0005    0.0006    0.0630
                              0.0749  0.1360  0.0566        0     0.0008    0.0630
                              0.0565  0.0566  0.3655        0     0.0005    0.0351
                             -0.0005       0       0    0.0689    0.0470    0.0004
                              0.0006  0.0008  0.0005    0.0470    0.0689        0
                              0.0630  0.0630  0.0351    0.0004         0    0.0792];
                ...
                case '0_45_3D'
                    tensor = [0.2900  0.0957  0.0795    0.0009   -0.0057    0.0173
                              0.0957  0.2701  0.0750    0.0053   -0.0009    0.0172
                              0.0795  0.0750  0.2661    0.0076   -0.0084    0.0069
                              0.0009   0.0053  0.0076   0.0756    0.0128   -0.0004
                             -0.0057  -0.0009 -0.0084   0.0128    0.0788    0.0003
                              0.0173   0.0172  0.0069  -0.0004    0.0003    0.0983];


                case '45_45_3D'
                    tensor = [0.2124  0.0831  0.0746   -0.0004   -0.0056    0.0285
                              0.0831  0.2121  0.0734    0.0027   -0.0005    0.0285
                              0.0746  0.0734  0.2979    0.0033   -0.0073    0.0122
                             -0.0004   0.0027  0.0033   0.0778    0.0185   -0.0009
                             -0.0056  -0.0005 -0.0073   0.0185    0.0785   -0.0002
                              0.0285   0.0285  0.0122  -0.0009   -0.0002    0.0904];
