classdef Anisotropic_45_45_LevelSet < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_45_45_LevelSet()
            obj.init()
            obj.createMesh();
            ...
            obj.designVariable.fun.print('fValues_45_45_LevelSetV5');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '-45_45';
            s.gif = true;
            s.gifName = 'Gif_45_45_LevelSetv5';
            s.printing = false;
            s.printName = 'Results_45_45_LevelSetv5';
