classdef Anisotropic_0_90_LevelSet_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_0_90_LevelSet_3D()
            obj.init()
            obj.createMesh();
            ...
            figure(2);
            saveas(gcf,'Monitoring_0_90_3D_LevelSet.fig');
            obj.designVariable.fun.print('fValues_0_90_3D_LevelSet');
            % obj.designVariable.fun.print('fValues_0_90_3D_LevelSet_MBB');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            s.printing = true;
            s.printName = 'Results_0_90_3D_LevelSet';
