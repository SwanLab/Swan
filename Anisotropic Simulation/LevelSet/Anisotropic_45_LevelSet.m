classdef Anisotropic_45_LevelSet < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_45_LevelSet()
            obj.init()
            obj.createMesh();
            ...
            %saveas(gcf,'Monitoring_45_LevelSetV2.fig');
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '45';
            s.gif = true;
            s.gifName = 'Gif_45_LevelSet_MBB';
            s.printing = false;
            s.printName = 'Results_45_LevelSet_MBB';
