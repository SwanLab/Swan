classdef Anisotropic_0_45_LevelSet < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_0_45_LevelSet()
            obj.init()
            obj.createMesh();
            ...
            %saveas(gcf,'Monitoring_0_45_LevelSet.fig');
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            s.printing = false;
            s.printName = 'Results_0_45_LevelSet_MBB';
