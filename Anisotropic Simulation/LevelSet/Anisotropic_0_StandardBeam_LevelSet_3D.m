classdef Anisotropic_0_StandardBeam_LevelSet_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_0_StandardBeam_LevelSet_3D()
            obj.init()
            obj.createMesh();
            ...
            figure(2);
            saveas(gcf,'Monitoring_0_Standard:3D_LevelSet.fig');
            obj.designVariable.fun.print('fValues_0_Standard_3D_LevelSet');
    ...
    methods (Access = private)
        ...
        function createMesh(obj)
            ...
            obj.mesh = TetraMesh(2,1,1,50,25,25 ...
                );
        end
        ...
        function createOptimizer(obj)
            ...
            s.printing = true;
            s.printName = 'Results_0_Standard_3D_LevelSet';
