classdef Anisotropic_0_45_LevelSet_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = Anisotropic_0_45_LevelSet_3D()
            obj.init()
            obj.createMesh();
            ...
            figure(2);
            saveas(gcf,'Monitoring_0_45_3D_LevelSet.fig');
            obj.designVariable.fun.print('fValues_0_45_3D_LevelSet');
            % obj.designVariable.fun.print('fValues_0_45_3D_LevelSet_MBB');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = false;
            s.gifName = 'Gif_0_45_3D_LevelSet';
            s.printing = true;
            s.printName = 'Results_0_45_3D_LevelSet';
