classdef BridgeLevelSetSegment < handle
    ...
    methods (Access = public)
        ...
        function obj = BridgeLevelSetSegment()
            obj.init()
            obj.createMesh();
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            s.gJFlowRatio    = 2;
            s.gif = true;
            s.gifName = 'BridgeLevelSetSegment';
            s.printing = true;
            s.printName = 'Results/BridgeLSSegment';
