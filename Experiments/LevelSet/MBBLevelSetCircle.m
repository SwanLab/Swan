classdef MBBLevelSetCircle < handle
    ...
    methods (Access = public)
        ...
        function obj = MBBLevelSetCircle()
            obj.init()
            obj.createMesh();
    ...
    methods (Access = private)
        ...
        function createIsoFilter(obj)
            s.trial = LagrangianFunction.create(obj.mesh,1,'P1');
            s.mesh = obj.mesh;
            s.filterType = 'PDE';
            s.boundaryType = 'Neumann';
            s.metric = 'Isotropy';
            obj.filterIso = Filter.create(s);
        end
        ...
        function createPerimeterConstraint(obj)
            ...
            s.mesh    = obj.mesh;
            s.uMesh   = obj.createBaseDomain();
            s.filter  = obj.filterIso;
            s.epsilon = 4*h;
            s.minEpsilon = 4*h;
            s.value0  = 1;
            s.target = 24.2482*0.25;
        ...
        function createOptimizer(obj)
            ...
            s.gJFlowRatio    = 2;
            s.gif = true;
            s.gifName = 'MBBLevelSetCircle';
            s.printing = true;
            s.printName = 'Results/MBBLSCircle';
