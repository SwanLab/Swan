classdef GripperDensityGlobalSegment < handle
    ...
    methods (Access = public)
        ...
        function obj = GripperDensityGlobalSegment()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'Experiments/Density/GripperLevelSetGlobalSegment.fig');
            obj.designVariable.fun.print('Experiments/Density/GripperLevelSetGlobalSegmentfValues');
        end
