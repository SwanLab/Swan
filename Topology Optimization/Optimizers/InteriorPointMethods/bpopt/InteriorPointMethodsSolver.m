    ...
    methods (Access = public)
        ...
        function zUpdater(obj)
            if (obj.bp.z_update==2)
                ...
                for i = 1:obj.ns,
                    zLC(n+i) = obj.bp.mu / (obj.s(i) - obj.sL(i));
                end
                ...
                for i = 1:ns,
                    zUC(n+i) = obj.bp.mu / (obj.sU(i) - obj.s(i));
                end
                obj.zL = zLC;
                obj.zU = zUC;
            end
        ...
        function linearSystemSolver(obj)
            ...
            obj.testLinearSystemDefinitiness();
            obj.conditionPrinter(idebug,A1,A2,search1,search2);
        ...
        function computeAcceptancePoint(obj)
            ...
            switch(obj.bp.z_update)
                case(1)
                    ...
                    zLa = obj.zL + obj.alpha_du * obj.dzL';
                    zUa = obj.zU + obj.alpha_du * obj.dzU';
                case(2)
                    % update explicitly from z = mu / x
                    for i = 1:obj.n,
