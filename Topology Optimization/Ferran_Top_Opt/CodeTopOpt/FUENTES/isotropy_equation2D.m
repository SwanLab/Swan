function [C_Ciso,gradient_constraint] = isotropy_equation2D (design_variable,compliancefun)
...
% C-Ciso
C_Ciso = [0.5*(matCh(1,1) - matCh(2,2)); ...
          0.5*(matCh(2,2) - matCh(1,1)); ...
          0.5*(matCh(3,3) - 0.5*(matCh(1,1) + matCh(2,2)) - matCh(2,1)); ...
          matCh(2,3); ...
          matCh(1,3); ...
          0];
...
% Eqn 1
selectiveC_Cstar(1,1,1) = 0.5;
selectiveC_Cstar(2,2,1) = -0.5;

% Eqn 2
selectiveC_Cstar(1,1,2) = -0.5;
selectiveC_Cstar(2,2,2) = 0.5;

% Eqn 3
selectiveC_Cstar(1,1,3) = -0.25;
selectiveC_Cstar(2,2,3) = -0.25;
selectiveC_Cstar(3,3,3) = 0.5;
selectiveC_Cstar(2,1,3) = -0.5;
