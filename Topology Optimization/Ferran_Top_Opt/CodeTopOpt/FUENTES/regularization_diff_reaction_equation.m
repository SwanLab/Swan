            ...
            case 'gamma'
                switch  algorithm
                    ...
                    case 'level_set'
                        ...
                        %f_reg = Rinv\M2;
                        dim.nunkn = 1;
                        f_reg = generalized_solver(zeros(size(M2)),Rinv,element,element.free_df_per,element.fix_df_per,dim,element.fixnodes_perimeter,M2);
                    ...
                    otherwise % case 'Projected_gradient'
                        ...
                        %f_reg = Rinv\rhs;
                        dim.nunkn = 1;
                        f_reg = generalized_solver(zeros(size(rhs)),Rinv,element,element.free_df_per,element.fix_df_per,dim,element.fixnodes_perimeter,rhs);
            ...
            case 'gradient'
                switch  algorithm
                    ...
                    case 'level_set'
                        ...
                        %f_reg = Rinv\rhs;
                        dim.nunkn = 1;
                        f_reg = generalized_solver(zeros(size(rhs)),Rinv,element,1:dim.npnod,[],dim,[],rhs);
