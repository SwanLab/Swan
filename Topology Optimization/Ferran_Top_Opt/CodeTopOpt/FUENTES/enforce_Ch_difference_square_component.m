function [Ch_diff2,gradient_Ch_diff] = enforce_Ch_difference_square_component ( design_variable,epsilon,compliancefun,epsilon_Le_kernel,kernel_case,diff_react_equation,ritz_gradient_representation,Msmooth,typeCdifference,component,initial_values )
...
Ch_diff2 = (costval(component))^2 - epsilon;
gradient_Ch_diff = 2*costval(component)*gradientval(:,component);
