classdef LevelSetPeriodicAndOriented < LevelSetCreator
    ...
    methods (Access = private)
        ...
        function [y1,y2] = applyMapping(obj)
            ...
            y1 = obj.interpolateFunction(y1,obj.mesh);
            y2 = obj.interpolateFunction(y2,obj.mesh);
        end

        function interpolateM1M2(obj)
            m1 = obj.cellLevelSetParams.widthH;
            m2 = obj.cellLevelSetParams.widthV;
            m1 = obj.createDiscontinousValues(m1,obj.mesh);
            m2 = obj.createDiscontinousValues(m2,obj.mesh);
        ...
        function thresholdParameters(obj)
            ...
            %     p = obj.createDiscontinousValues(p,obj.mesh);
        ...
        function interpolateDilatation(obj)
            r = obj.dilation;
            rD = obj.createDiscontinousValues(r,obj.mesh);
            r  = obj.interpolateFunction(rD,obj.mesh);
            obj.dilation = r;
        end
        ...
        function fV = createDiscontinousValues(obj,r,m)
            s.mesh    = m;
            s.fValues = r;
            fC = P1Function(s);
            fD = fC.project('P1D');
