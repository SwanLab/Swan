function   [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,INICOND,DATA,OTHER_data] ...
    =  PreProcessInpDatDyn_EIFEbubCOROT(DATA,PROPMAT,DIRICHLET,NEUMANN,INITIAL_CONDITIONS,OTHER_INPUTS)
% Adaptation of PreProcessInputDataDyn1_EIFEbub.m to  CO-ROTATIONAL
% FORMULATION
