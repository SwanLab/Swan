...
% Adaptation of GeometricMatricesFun_EIFEbub.m 
...
[OPERFE.D_BmatIst,Nmat_allelem,WEIGHTSinteg,TRANSF_COORD,MESH.CN,DATA,OPERFE.D_KcLINloc,MESH.CN_SUPPORT,OPERFE.QrotINI,OPERFE.lambdaLEN,OPERFE.D_Wecm,...
    OPERFE.INDEXsparseROTmat,OPERFE.LboolCall,OPERFE.XcALL,OPERFE.D_YcmpD,  OPERFE.D_Zfict  ]=...
    B_N_matricesEIFEbubCOROT2(MESH.COOR,MESH.CN, PROPMAT,MESH.MaterialType,DATA,MESH.TypeElement,CN_SUPPORT ) ;
