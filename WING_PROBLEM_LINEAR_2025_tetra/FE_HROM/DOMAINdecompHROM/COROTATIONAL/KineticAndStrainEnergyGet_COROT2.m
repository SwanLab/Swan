function VAR = KineticAndStrainEnergyGet_COROT2(VAR,OPERFE,DATA,MATPRO,FgradST,dCqLOC,D_QrotALL,dClocINCRE)
...
if DATA.CECM_ONLY_FOR_NONLINEAR_STRESSES == 0
  ...
  %  VAR.Delta_dCqLOC = D_QrotALL'*(OPERFE.LboolCall*VAR.DISP) - dCqLOC ;
    VAR.STRAIN_ENERGY  = 0.5*VAR.dClocINCRE'*(OPERFE.D_KcLINloc*VAR.dClocINCRE);
