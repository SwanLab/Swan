function [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,...
    INICOND,DATA,OTHER_output] =  INPUTS_EIFE_shapeBUBunc(DATAINPUT)
% Typical file for the EIFE, vectorized method
...
DATAINPUT.DATAcommon = DefaultField(DATAINPUT.DATAcommon,'MERGE_ELEMENTS_MESHES_UNCOUPLED_EIFEM',0);
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/107_EIFEM_plast3D/06_UNCOUPLED.mlx
 DATA.MERGE_ELEMENTS_MESHES_UNCOUPLED_EIFEM = DATAINPUT.DATAcommon.MERGE_ELEMENTS_MESHES_UNCOUPLED_EIFEM ; 
...
OTHER_INPUTS.DATAcommon = DATAINPUT.DATAcommon ; 
%
[MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,INICOND,DATA,OTHER_output] ...
    =  PreProcessInputDataDyn1_EIFEbub(DATA,PROPMAT,DIRICHLET,NEUMANN,INITIAL_CONDITIONS,OTHER_INPUTS) ;
...
GAUSSV_PROP.VONMISES_CAUCHY_STRESS.PRINT = 0 ;
