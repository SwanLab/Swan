...
% /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/104_EIFEM_plast2D/104_README_EIFEM_p2D.mlx
% /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/104_EIFEM_plast2D/04_GeneralTheory.mlx
%% JAHO, 23-sept-2023/8-oct-2023
...
%
% DATAoffline = DefaultField(DATAoffline,'TOLSVD_DETERMINE_INVARIANT_DEF_MODES',1e-4) ; %
% DATAoffline = DefaultField(DATAoffline,'RUN_TO_DETERMINE_INVARIANT_DEF_MODES',0) ; %
%
...
DATALOC.TOL = 1e-8; 
[ PhiDEFbs,Sbs,Vbs,MdomCHOL] = WSVDT( SNAPbasic,Mdom,DATALOC) ;
