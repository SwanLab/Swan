function EIFEoper = EIFE_operatorsBUBgen(INPUT_PROBLEMS,DATAoffline)
% Initially, a modification of EIFE_operatorsFUN.m to account for bubble modes
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/104_EIFEM_plast2D/04_GeneralTheory.mlx
% Then it was updated in order to deal with the consistent method (Feb2025).
% See previous version:   EIFE_operatorsBUB.m
% JAHO, 23-FEb-2025, Sunday, 19:19, Balmes 185, Barcelona 
...
if ~isempty(MESHdom.BNDlateral)
    error('There is some issue with this part...Fix it. 23-Feb-2025')
    ...
    disp('There are no non-interface boundaries in this problem')
end
