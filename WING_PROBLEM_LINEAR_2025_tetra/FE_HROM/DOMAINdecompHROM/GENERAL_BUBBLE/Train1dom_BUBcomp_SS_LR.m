% function Train1dom_BUBcomp_SS_LR(DATAlauch,INPUT_PROBLEMS,NameWS_EIFE_oper,DATAoffline)
% % This is a modified version of Train1dom_BUBcomp.m
...
% % As an example of how to use it, run 
% % /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/109_EIFEM_largeROT/05_COROT_SSLR/Train_BEAML_1n.m
% 
...
% 
% % -----------------------------------------------------
% % 30-JAN-2023/25-Feb-2023/4-Feb-2025,  JAHO, BAlmes 185, Barcelona 
% % ------------------------------------------------------
% % Inputs
% % ----------------
% if nargin == 0
...
%   %  OFFLINE_STEPSbubCOMPL_SS_LR(INPUT_PROBLEMS,DATAoffline) ;
...
%    % EIFEoper = EIFE_operatorsBUBssLR(INPUT_PROBLEMS,DATAoffline)  ;
