...
% Adaptation of PreProcessInputDataDyn1.m to the Empirical Interscale
% Finite Element Method 
% JAHO, 20-March-2023, Teknoc clinic, Barcelona
OTHER_data =[] ;
if nargin == 0
    load('tmp.mat')
end
...
%DATALOC.MESH_GIVEN_BY_THE_USER_FUNCTION
...
[Bst_F,wSTs,Nst,wSTs_RHS,NstT_W_N_boundaries,ngaus_RHS,GEOproperties,ngaus_STRESS,IDENTITY_F,posgp,MESH,DATA,KstiffLINEAR] ...
