function Train1domFLUCT_all(DATAlauch,INPUT_PROBLEMS,NameWS_EIFE_oper,DATAoffline)
...
% Adaptation to fixed fluctuation case, 3-Dec-2023
% ------------------------------------------------------
% Inputs
% ----------------
if nargin == 0
...
if DATAlauch.TRAINING ==1
    ...
    Training_MULTIfluct(INPUT_PROBLEMS,DATAoffline) ;
end
