function [Vall,Mintf,MESH,DATA,FluctuationFacesGLO] = FictInterfaceDISP_QUADlin(PhiDEF,PsiDEFf,MESH,DATAcommon,DATA,Mintf,PhiRB,PsiRBf,DATAoffline)
...
if  ~ischar(COMB_FACES)
    ...
    if ~isempty(DATAoffline.MESH_QUADRATIC_PARENT_DOMAIN)
        ...
        COORquad = COORquadFromFileQ(DATAoffline.MESH_QUADRATIC_PARENT_DOMAIN,MESH.GEOproperties.CENTROID,DATAcommon) ;
    else
