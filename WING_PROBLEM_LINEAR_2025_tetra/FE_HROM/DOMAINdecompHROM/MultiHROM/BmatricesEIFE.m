function [Bmat,w,x,MATPRO,RECONS_PK2stresses,index_elements,Bgrad,PhiDEFelem]  = ...
    BmatricesEIFE(PhiDEF,PdownsDEF,CECM_intforces,BstFE,DATAoffline,DATA,MATPRO,BasisStwo,MESH) 
