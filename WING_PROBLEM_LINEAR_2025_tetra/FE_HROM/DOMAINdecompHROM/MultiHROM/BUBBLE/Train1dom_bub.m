...
% 5-June-2023 (bubble modes)
% See/home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/101_MULTI2D_2023/09_POSTPAPER_POROUS/02_bubbleMODES.mlx 
% ------------------------------------------------------
% Inputs
% ----------------
if nargin == 0
...
if DATAlauch.OFFLINE_modes_points ==1
    ...
    OFFLINE_STEPSbubble(INPUT_PROBLEMS,DATAoffline) ;
     
    
end
% EMPIRICAL INTERSCALE FINITE ELEMENT OPERATORS (EIFE)
if DATAlauch.ONLINE_OPERATORS == 1
    EIFEoper = EIFE_operatorsFUN(INPUT_PROBLEMS,DATAoffline)  ;
