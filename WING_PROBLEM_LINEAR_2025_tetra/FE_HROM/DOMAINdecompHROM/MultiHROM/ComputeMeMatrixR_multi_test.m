function Me = ComputeMeMatrixR_multi_test(Xe,EIFEoper,Vrot) 
% This is a copy, for testing purpose, of 
% /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/101_MULTI2D_2023/01_HOMOG/01_INNER_DOM/NonVectorElastCode/ComputeMeMatrixR_multi.m
if nargin == 0
    load('tmp1.mat')
end

weig = EIFEoper.BodyForces.weights ;  % CECM weights
