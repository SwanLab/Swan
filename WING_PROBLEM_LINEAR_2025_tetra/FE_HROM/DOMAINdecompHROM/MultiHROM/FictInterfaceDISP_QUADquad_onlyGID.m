function [Vrb,MESH,DATA,INFOPLOTMESHBND] = FictInterfaceDISP_QUADquad_onlyGID(MESH,DATAcommon,DATA,DATAoffline)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DATAcommon= DefaultField(DATAcommon,'MESH_PARENT_DOMAIN_COARSE',[]) ;  % JAHO 18-APR-2024, .MESHcoarse IS A MORE GENERIC WAY TO REFER TO
...
[Nshape,~,~] = ShapeFunDer_inversemapping(COORquad',COORbnd,TypeElement,DATAoffline) ;
DATAlocSHAPE = []  ;
