function [Vall,Mintf,MESH,DATA] = FictInterfaceDISP_20nodes(PhiDEF,PsiDEFf,MESH,DATAcommon,DATA,Mintf,PhiRB,PsiRBf,DATAoffline)
% Fictitious interface modes for hexahedra elements (20 nodes)
% See 
...
COORhexa = [COORcorners;COORmidLINES  ] ; 


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DATAoffline= DefaultField(DATAoffline,'MESH_QUADRATIC_PARENT_DOMAIN',[]) ;
% Recalculate midside coordinates
COORhexa = RecalculatePositionNodesHEXA20(COORhexa,DATAoffline.MESH_QUADRATIC_PARENT_DOMAIN,MESH.GEOproperties.CENTROID) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PLOT_POINTS = 0;
if PLOT_POINTS == 1
    figure(89)
...
DATAoffline = DefaultField(DATAoffline,'ORDER_INVERSE_ELEMENT_inverse_mapping',2) ;
DATAoffline = DefaultField(DATAoffline,'NPOINTS_ONE_DIRECTION_inverse_mapping',10) ;

error('Option to be implemented...review this part of the code')
    
    
    DATAinp.Compute_Bmatrix = 0 ; 
    [Nshape,~,~] = ShapeFunDer_inversemapping(COORhexa',COORbnd,TypeElement,DATAinp) ;
    DATAlocSHAPE = []  ;
