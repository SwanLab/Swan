function [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,INICOND,DATA,OTHER_output] =  INPUTS_TRAIN_PLATESh(DATAINPUT)
% % Typical input data file for running structural problems corresponding
% to "training" cases (for plates)
%/home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/101_MULTI2D_2023/02_PLATES/README_PLATES.mlx
% Archetypical file defining the missing inputs: /
%home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/101_MULTI2D_2023/02_PLATES/01_QUADPL/DefineInputs_PLATEq.m
...
OTHER_INPUTS.TypeFunctionDisplacementTRAINING = 'PLATE_ELEMENT_FROM_LINEAR_HEXAHEDRA_ELEMENT' ;
%DATA.TypeFunctionDisplacementInterfaces = 'PLATE_QUAD_LINEAR' ;
