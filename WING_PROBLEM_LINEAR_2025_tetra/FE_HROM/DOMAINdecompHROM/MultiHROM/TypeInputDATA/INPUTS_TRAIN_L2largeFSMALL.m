function [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,INICOND,DATA,OTHER_output] =  INPUTS_TRAIN_L2largeFSMALL(DATAINPUT)
...
DATAINPUT = DefaultField(DATAINPUT,'TypeProblem','3D') ; 
    DATA.typePROBLEM = DATAINPUT.TypeProblem ;
%else
...
DATA.StrainStressWith4Components = 0 ;  
...
DATAINPUT.PARAM = DefaultField(DATAINPUT.PARAM,'NEUMANN',[]) ; 
[NEUMANN] =DATAINPUT.PARAM.NEUMANN; ; %eval(DATAINPUT.DATAcommon.NeumannBoundaryConditions,DATAINPUT) ;  % DirichletBoundaryConditionsFUN(tEND) ;
% %
% % --------------------------------------------------------------------
...
DATAINPUT = DefaultField(DATAINPUT,'NPOINTS_ONE_DIRECTION_inverse_mapping',10) ;
 ...
 DATAINPUT = DefaultField(DATAINPUT,'BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES',[]) ;
...
DATAINPUT.PARAM = DefaultField(DATAINPUT.PARAM,'TypeFunctionDisplacementTRAINING','');  

OTHER_INPUTS.TypeFunctionDisplacementTRAINING = DATAINPUT.PARAM.TypeFunctionDisplacementTRAINING ;
OTHER_INPUTS.BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES = DATAINPUT.BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES ;
...
DATAINPUT = DefaultField(DATAINPUT,'MESHcoarse',[]) ; 

OTHER_INPUTS.MESHcoarse_FOR_DIRICHLET_BOUND_COND = DATAINPUT.MESHcoarse  ;

DATA.NO_USE_Deformation_gradient_in_Small_Strains = 0 ; % = DefaultField(DATA,'NO_USE_Deformation_gradient_in_Small_Strains',1) ; 
