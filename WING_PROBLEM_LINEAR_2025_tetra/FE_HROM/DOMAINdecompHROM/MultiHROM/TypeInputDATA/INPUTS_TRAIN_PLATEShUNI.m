function [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,INICOND,DATA,OTHER_output] =  INPUTS_TRAIN_PLATEShUNI(DATAINPUT)
% % Data file for running structural problems corresponding
...
[DIRICHLET] = DirichletBND_RB(DATAINPUT.PARAM.FACES_PRESCRIBED_DISPLACEMENTS,...
    DATAINPUT.PARAM.PRESCRIBED_DISPLACEMENTS,   DATAINPUT.tEND) ; 

 

% % -------------------------------------------------
% % 5. External forces  (NEUMANN CONDITIONS, POINT FORCES AND BODY FORCES)
[NEUMANN] =  NeumannLocalForce(DATAINPUT.PARAM.FACES_PRESCRIBED_TRACTIONS,DATAINPUT.PARAM.PRESCRIBED_TRACTIONS,   DATAINPUT.tEND) 
