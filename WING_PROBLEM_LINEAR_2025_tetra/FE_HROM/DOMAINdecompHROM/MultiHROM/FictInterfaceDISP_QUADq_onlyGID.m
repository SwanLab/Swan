function [Vall,Mintf,MESH,DATA,INFOPLOTMESHBND] = FictInterfaceDISP_QUADq_onlyGID(PhiDEF,PsiDEFf,MESH,DATAcommon,DATA,Mintf,PhiRB,PsiRBf,DATAoffline)
