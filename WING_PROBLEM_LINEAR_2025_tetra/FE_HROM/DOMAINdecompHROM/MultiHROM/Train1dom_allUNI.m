function Train1dom_allUNI(DATAlauch,INPUT_PROBLEMS,NameWS_EIFE_oper,DATAoffline)
...
% -----------------------------------------------------
% 30-JAN-2023/25-Feb-2023,13-Aug-2023, JAHO
% ------------------------------------------------------
% Inputs
% ----------------
if nargin == 0
...
if DATAlauch.TRAINING ==1
    ...
    Training_MULTIuni(INPUT_PROBLEMS,DATAoffline) ;
end
