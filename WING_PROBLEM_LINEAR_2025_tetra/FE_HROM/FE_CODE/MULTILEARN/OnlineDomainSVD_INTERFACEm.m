function [maxD] =OnlineDomainSVD_INTERFACEm(NAMEWS,DATAONLINE,DATAINM)
...
% %DATAINM.SURPLUS_NUMBER_DISPLACEMENT_MODES = 3;
% DATAINM = DefaultField(DATAINM,'SURPLUS_NUMBER_DISPLACEMENT_MODES',0);
% ndiffMODES = DATAINM.SURPLUS_NUMBER_DISPLACEMENT_MODES ;
% BasisRdef{1} = BasisRdef{1}(:,1:(end-ndiffMODES));
