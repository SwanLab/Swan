function  [DOFr DOFm G dR dispMACRO DATA] = Periodic_BoundaryCONDhexaMINbcs(COOR,CN,MACRODEF,CNb,DATA)
...
% % Joaquín A. Hernández (jhortega@cimne.upc.edu), 29-Oct-2015/May-2017
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%dbstop('22')
if nargin==0
    load('tmp3.mat')
...
[MASTER SLAVES] =MasterSlavesSetsHexaBCS(NODESpl,NODESln,NODESpnt,COOR,TOL,NormalPlanes) ;
