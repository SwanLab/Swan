function GidPostPlotScalarNodesNEW(var,ndime,NODES,time_step,NF,fid_res)
...
ndime = 1; 
var = reshape(var,ndime,length(NODES)) ;
%time_step = TIMEVECTOR(istep) ;
fprintf(fid_res, ['Result ',NAME,' "Load Analysis" '  num2str(time_step) ' Scalar OnNodes  \n' ],[]);
% if ndime==2
