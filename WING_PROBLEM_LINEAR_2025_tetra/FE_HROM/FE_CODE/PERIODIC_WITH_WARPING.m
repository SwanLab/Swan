% Copy of PERIODIC_BEAMS_MASS_MATRIX
% Incorporation of warping modes , 16-Jan-2019
% ----------------------------------------------------
...
if OKK ==1
    ...
    if isempty(ROTMATRIX)
        % Straight domains
        [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = PERIODIC_BEAMS_MASS_MATRIXfun(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA) ;
    else
        % Curved domains
