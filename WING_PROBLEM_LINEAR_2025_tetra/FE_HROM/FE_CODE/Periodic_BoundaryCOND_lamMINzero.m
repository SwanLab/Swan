function  [DOFr DOFm G dR dispMACRO NODESpl] = Periodic_BoundaryCOND_lamMINzero(COOR,CN,strainINP,CNb,DATA,TypeElementB)
...
nDOFm = 3*length(nodm)  +2*length(MASTER_uvFL)  ;  % Number of master DOFm
...
% MASTER DOFs 
% -----------
[DOFm ROWSmst] = AssemDOFmst_PERIOD_TBmin(nDOFm,nodm,MASTER_uvFL) ; 
% Matrix G 
% --------
