function  [DOFr DOFm G dR dispMACRO NODESpl] = ZeroCOND_lam(COOR,CN,strainINP,CNb,DATA)
...
nodm = [] ;
nods = unique([NODESpl{1,1};NODESpl{1,2};NODESpl{2,1};NODESpl{2,2}]);
