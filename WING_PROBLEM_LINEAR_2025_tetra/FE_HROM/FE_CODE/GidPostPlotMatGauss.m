function GidPostPlotMatGauss(var,nstrain,npg,nElem,time_step,NF,DATA,fid_res,ndime,setElementsRED)
...
if ndime ==2
    ...
    nomComponente =  ['"',NF.COMP{1},'" "',NF.COMP{2},'" "',NF.COMP{4},'" "',NF.COMP{3},'" '] ; % '"StressXX" "StressYY" "StressZZ"  "StressXY" ';
else
...
fprintf(fid_res,['Result  "',LABEL_LOC,'" "Load Analysis" ', num2str(time_step),' ',tipoDatAlmac,' OnGaussPoints "GPset"\n'],[],tipoDatAlmac);
