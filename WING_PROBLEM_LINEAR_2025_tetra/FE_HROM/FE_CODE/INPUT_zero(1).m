...
%[DOFr DOFm Gb dR dispMACRO] = Periodic_BoundaryCOND(COOR,CN,MACRODEF,CONNECTb,DATA) ;
%dbstop('81')
 [DOFr DOFm Gb dR dispMACRO ] = ZeroCOND_UNIT(COOR,CN,MACRODEF,CONNECTb,DATA);
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
