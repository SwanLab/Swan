...
U_j =  INPUTS_LOC.Ufluc_j ; 
U_r =  INPUTS_LOC.Ufluc_r ; 
...
if OKK ==1
    ...
    if isempty(ROTMATRIX)
        % Straight domains
        [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = PRESCRIBED_FLUCTUATIONS_withFORCESfun(U_j,U_r,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
            DATA) ;
    else
        % Curved domains
