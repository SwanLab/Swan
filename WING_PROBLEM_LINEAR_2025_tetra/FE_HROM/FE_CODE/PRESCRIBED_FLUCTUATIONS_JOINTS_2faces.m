...
if OKK ==1
[Gb,dR,DOFr,DOFm,AREA,R] = PRESCRIBED_FLUCTUATIONS_JOINTS2faces_fun(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA) ; 
else
  [Gb,dR,DOFr,DOFm,AREA,R] = PRESCRIBED_FLUCTUATIONS_JOINTS2faces_COARSE(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA,...
