function NAME_PROJ_LOC = FE_TRAIN_BEAM_bfree(NameFileMeshLOC,NameFileMeshLOC_coarse,...
...
%%%%%%%%%%%%%%%%%
nprojects = 6 ;
IMPOSED_DISP.RIGHT_END = cell(nprojects,6) ;
IMPOSED_DISP.LEFT_END = cell(nprojects,6) ;
IMPOSED_DISP.RIGHT_END(:,:) = {0} ; 
IMPOSED_DISP.LEFT_END(:,:) = {0} ; 
...
BoundaryConditions(5:end) = {'PRESCRIBED_FLUCTUATIONS_bfree'} ;
%---------------------------------------
iproj = 1;
...
IMPOSED_DISP.RIGHT_END{iproj,5}= [];
IMPOSED_DISP.RIGHT_END{iproj,6}= [];
