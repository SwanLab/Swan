function [G,uBAR,DOFr,DOFm,AREA,R,DOFA,DOFB,DATAOUT] = PERIODIC_BEAMS_COARSE_FINE(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
...
%     warning('Fine and coarse meshes correspond to different geometries. Perhaps they are in different locations')
% end
