function [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = ...
    PRESCRIBED_FLUCTUATIONS_AND_AMPLITUDESfun(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
    DATA,Ufluctuations,D_amplitude_fluctuations)
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/105_BackPeriodic/105_README.mlx
% JAHO, 4-Nov-2023, Barcelona, Balmes 185
if nargin == 0 
    load('tmp.mat')
end
...
[Gb,dR,DOFr,DOFm] = BCs_PRESCRIBED_FLUCTUATIONS_AND_AMPLITUDES(DOFA,DOFB,R,a_A,a_B,Rbar,M,Ufluctuations,D_amplitude_fluctuations) ; 
