function [CONNECTb_faces_coarse,TypeElementB ]= MatchingFineCoarseMesh(NameFileMeshLOC_coarse,COOR)
...
SLICE.NAME =NameFileMeshLOC_coarse ;
DATALOC.InterfacesDoNotMatch =1 ; 
DATA3D = GeometrySlice(SLICE,DATALOC) ; % New function, for reading mesh and node faces
