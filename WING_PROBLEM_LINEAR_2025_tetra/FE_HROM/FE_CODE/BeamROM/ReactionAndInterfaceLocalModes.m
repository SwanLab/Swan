function [BasisRdef,BasisINT,nBOUNDARY_INTFMODES] = ReactionAndInterfaceLocalModes(BasisUdef,BasisRdef,f1,f2,TOL_SINGULAR_VALUES_Hqr,...
    nBASES_BEAM,DATA_REFMESH,Vrb,M,DISP_BOUND,DATAIN)
if nargin == 0
    load('tmp.mat')
end
ndim = 3;
...
[U,S,Vbar] = SVDT(BasisREFERENCE,0) ;
BasisREFERENCE = U ;
nBOUNDARY_INTFMODES = [] ; 
