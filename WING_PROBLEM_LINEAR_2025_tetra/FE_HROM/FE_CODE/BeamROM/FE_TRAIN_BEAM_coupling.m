function NAME_PROJ_LOC = FE_TRAIN_BEAM_coupling(NameFileMeshLOC,NameFileMeshLOC_coarse,...
    NAME_DATA_REF,NAME_ROOT_FE_BEAM,EXECUTABLE_FOLDER,NUMBER_OF_SLICES)

% Copy of FE_TRAIN_BEAM.m. Special considerations to  simple bending
% JAHO, 7-June-2018
% --------------------------------------------------------------------------
...
BoundaryConditions(3:4) = {'PERIODIC_BEAMS_MASS_MATRIX'};
BoundaryConditions([1,2,5,6]) = {'BOUNDARY_COND_COUPLING'} ;
...
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,3)= 0;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,5)= 1;
%---------------------------------------
iproj = 2;
NAMEPROJECTS{iproj} =  [NAME_ROOT_FE_BEAM,NAME_PROJ_LOC{iproj}];;
NUMBER_OF_DOMAINS(iproj) = ndom	;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,2)= 0;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,6)= 1;
...
iproj = 5;
NAMEPROJECTS{iproj} =  [NAME_ROOT_FE_BEAM,NAME_PROJ_LOC{iproj}]; ;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,3)= 1;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,5)= 1;
...
iproj = 6;
NAMEPROJECTS{iproj} =  [NAME_ROOT_FE_BEAM,NAME_PROJ_LOC{iproj}]; ;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,2)= 1;
GENERALIZED_FORCES_ENDS_BEAM.RIGHT_END(iproj,6)= 1;
