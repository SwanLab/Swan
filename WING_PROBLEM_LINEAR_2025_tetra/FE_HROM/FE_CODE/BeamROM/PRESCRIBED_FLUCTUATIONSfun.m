function [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = ...
    PRESCRIBED_FLUCTUATIONSfun(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
    DATA,Ufluctuations)
...
[Gb,dR,DOFr,DOFm] = BCs_PRESCRIBED_FLUCTUATIONS(DOFA,DOFB,R,a_A,a_B,Rbar,M,Ufluctuations) ; 
