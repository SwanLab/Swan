function [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = ...
    PRESCRIBED_FLUCTUATIONS_withFORCESfun(U_j,U_r,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
    DATA)
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/105_BackPeriodic/03_IMPOSED_FORCES.mlx
% JAHO, 8-Nov-2023, Barcelona, UPC, CIMNE
if nargin == 0 
    load('tmp.mat')
end
...
[Gb,dR,DOFr,DOFm] = BCs_PRESCRIBED_FLUCTUATIONS_withFORCES(DOFA,DOFB,R,U_j,U_r) ; 
