function [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = ...
    PRESCRIBED_FLUCTUATIONS_withFORCESbendfun(U_b,U_n,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
    DATA,gammaB)
...
[Gb,dR,DOFr,DOFm] = BCs_PRESCRIBED_FLUCTUATIONS_withFORCES_bend(DOFA,DOFB,R,U_n,U_b,gammaB) ; 
else
