function  [DOFr DOFm G dR dispMACRO DATA] = Periodic_BoundaryCONDhexa(COOR,CN,MACRODEF,CNb,DATA)
...
DATA.VOL_RVE = 3/4*(xmax-xmin)*(ymax-ymin)*(zmax-zmin) ; 
...
[NODESpl NormalPlanes]=  DetermineePlanesPeriodicHexa(COORbound,TOL,xmax,xmin,ymax,ymin,zmax,zmin,NODESbound) ;
% -------------------------------------------------
% LINES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[NODESln  PLANESlines]= DetermineLinesPeriodicHEXA(NODESpl) ; 
%%% POINTS
[NODESpnt ]= DeterminePointsPeriodicHEXA(NODESln) ;

%%% REMOVE INTERSECTIONS
% From planes
NODESpl = RemoveLinesPlanesHEXA(NODESpl,NODESln,PLANESlines) ;
% From lines
...
[MASTER SLAVES] =MasterSlavesSetsHexa(NODESpl,NODESln,NODESpnt,COOR,TOL,NormalPlanes) ;
