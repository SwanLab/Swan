...
if OKK ==1
[Gb,dR,DOFr,DOFm,AREA,R,Fpnt_Dirichlet,DOFA,DOFB] = ...
    BOUNDARY_COND_MIXED_fun(DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA,b_A,b_B) ; 

else
     error('This option proved to be inconsistent')
...
%       TypeElementB,INPUTS_LOC.NameFileMeshLOC_coarse,DATA) ;  ; 
    [Gb,dR,DOFr,DOFm,AREA,R,Fpnt_Dirichlet,DOFA,DOFB] = ...
    BOUNDARY_COND_MIXED_CF_fun(DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA,b_A,b_B,...
    INPUTS_LOC.NameFileMeshLOC_coarse) ; 
 end
