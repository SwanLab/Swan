...
function GidPostProcessModes_1dim(COOR,CN,TypeElement,MODES,posgp,NameFileMesh,DATA,DOFl);
...
GidResults2DFE_modes_1dim(NameFile_res,COOR,CN,TypeElement,MODESplot,posgp,DATA);
