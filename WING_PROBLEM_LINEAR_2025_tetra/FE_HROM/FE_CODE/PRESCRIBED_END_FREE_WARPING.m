...
if OKK ==1
   % [Gb,dR,DOFr,DOFm,AREA,R] = PRESCRIBED_END_FREE_WARPING_funNEW(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA) ;
    
    % Before 20-Sept-2018. 
        [Gb,dR,DOFr,DOFm,AREA,R] = PRESCRIBED_END_FREE_WARPING_fun(a_A,DOMAINVAR,COOR,CONNECTb,TypeElementB,DATA) ;

else
     
     [Gb,dR,DOFr,DOFm,AREA,R] = ...
          PRES_FREEWARP_COARSE_FINE(a_A,DOMAINVAR,COOR,CONNECTb,...
