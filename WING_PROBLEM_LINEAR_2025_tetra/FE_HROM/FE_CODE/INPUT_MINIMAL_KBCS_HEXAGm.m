function [COOR,CN,TypeElement,TypeElementB, celasglo,  DOFr,dR,...
    ...
    DATA,MaterialType] = INPUT_MINIMAL_KBCS_HEXAGm(INPUTS_LOC,DATA) ;

% See ALEX_THESIS_mine.pdf
% Kinematically minimal BCs
...
DATA.nameWORKSPACE = ['DATAWS/',NameFileMesh_ave,'_WS.mat'] ; % To retrieve already read data
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if  ndim == 3
    [DOFr DOFm Gb dR dispMACRO DATA] = MINIMAL_KBCS_HEXAGm(COOR,CN,MACRODEF,CONNECTb,DATA,TypeElementB) ;

else
    [DOFr DOFm Gb dR dispMACRO DATA] = MINIMAL_KBCS_HEXAGm2D(COOR,CN,MACRODEF,CONNECTb,DATA,TypeElementB) ;
