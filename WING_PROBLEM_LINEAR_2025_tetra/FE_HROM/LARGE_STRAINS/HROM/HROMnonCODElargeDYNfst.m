function  [BasisUall,RECONS_PK2stress,OTHER_output ]=  HROMnonCODElargeDYNfst(DATAFILE,PARAMETERS)
%--------------------------------------------------------------------------
% function [BasisUall, RECONS_PK2stress, OTHER_output] = HROMnonCODElargeDYNfst(DATAFILE, PARAMETERS)
%
% PURPOSE:
...
if PARAMETERS.ONLY_PRINT_GID == 0
    if DATAHROM.ISDYNAMIC == 0
      %  [DATAHROM,CONVERGED]=NONLINEARstaticLARGE_manifoldFST(DATAHROM,DISP_CONDITIONS,VAR,OPERHROM,SNAP,Fbody,Ftrac,MATPRO) ;
