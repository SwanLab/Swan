function  GidPostProcessModesDOML(COOR,CN,TypeElement,MODES,posgp,NameFileMesh,NameFile_res,MaterialType,DATA)
...
NAMEPROJ = 'project... ';
GidMesh2DFE(NameFileMesh,COOR,CN,NAMEPROJ,MaterialType,TypeElement);
