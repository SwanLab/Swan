function [NODES_SNAP,GAUSS_SNAP] = INITIALIZATIONsnap(DATA,NODESV_n,GAUSSV_n,NODESV_PROP,GAUSSV_PROP) 

% Initialization SNAPSHOT matrices (Gauss variabes, nodal variables)
% See function [NODESV,GAUSSV,NODESV_PROP,GAUSSV_PROP] = INITIALIZATIONvar(DATA,INICOND)
% JAHO, 26-Nov-2020
