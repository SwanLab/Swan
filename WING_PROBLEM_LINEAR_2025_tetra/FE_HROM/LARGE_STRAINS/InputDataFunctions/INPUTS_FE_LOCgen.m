function [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,...
    INICOND,DATA,OTHER_output] =  INPUTS_FE_LOCgen(DATAINPUT)
...
DATAINPUT.DATAcommon= DefaultField(DATAINPUT.DATAcommon,'SMALL_STRAIN_KINEMATICS',DATAINPUT.SMALL_STRAIN_KINEMATICS) ; 
...
DATAINPUT = DefaultField(DATAINPUT,'PERIODICITY_FACES',[]) ; 
