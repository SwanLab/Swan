function [Nshape,COORnodes,OTHER_OUTPUT] =  LinearCubicPieceWise2Dmodes_EIFEM(INFO_INTERFACE_MESH,CENTROID,COORbnd)
% JAHO, 5-APRIL-2025, SUNDAY, HGs, Tuset, BARCELONA
% Computation of Nshape for the interface ficti. modes, in EIFEM
% mIXED CUBIC/LINEAR INTERPOLATIONS, 2D.
...
for ielem = 1:length(ElemBnd)
    ...
    elseif   length(ElemBnd{ielem}) == 4
        ...
        [Nshape,xiEDGES{ielem},IndPointsBNDedge{ielem}] =   CubicShapeFun3nodes(ElemBnd{ielem},COORnodes,COORbnd,Nshape) ;
        
        NumberNodesPerEdge(ielem) = 4;
