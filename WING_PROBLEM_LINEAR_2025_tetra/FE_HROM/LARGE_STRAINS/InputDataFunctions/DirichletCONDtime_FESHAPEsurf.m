...
LabelEntitiesDefiningBoundary  = DATALOC.LabelEntitiesDefiningBoundary ; % FACES DEFINING THE BOUNDARIES OF THE FINE MESH DOMAIN

DIRICHLET = DefaultField(DIRICHLET,'BOUNDARY_SURFACES_TO_INCLUDE',LabelEntitiesDefiningBoundary) ; 

%if ~isempty(DATALOC.BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES)
    FACES_BND = DIRICHLET.BOUNDARY_SURFACES_TO_INCLUDE ; 
%else
%    FACES_BND = DATALOC.LabelEntitiesDefiningBoundary ; 
%end
