function  [DISP_CONDITIONS,INFO_PERIODIC_CONDITIONS] = PeriodicQ4_cornersHOM(DIRICHLET,DATA,ndim,MESH,...
    GEOproperties,DATALOC,COMB_FACES,DOFr_LINEAR,dR_LINEAR)

if nargin  ==0
    load('tmp1.mat')
end

rnodLOC =large2small(DOFr_LINEAR,ndim) ; 
...
V= dR_LINEAR.U(:,2) ; % Shortcut !!! 


a = dR_LINEAR.a(2,end);

AMPLIT = dR_LINEAR.a(2,:)/a;
...
dR.U = uBARb ;
dR.a =  AMPLIT; %  DIRICHLET.TIMEFUN(DATA.STEPS) ;
