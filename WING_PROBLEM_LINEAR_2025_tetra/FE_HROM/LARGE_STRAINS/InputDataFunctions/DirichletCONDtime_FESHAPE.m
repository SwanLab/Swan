function [DOFr,dR] = DirichletCONDtime_FESHAPE(DIRICHLET,DATA,ndim,MESH,GEOproperties,DATALOC)
...
DATALOC = DefaultField(DATALOC,'BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES',[]) ; 

if ~isempty(DATALOC.BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES)
    FACES_BND = DATALOC.BOUNDARY_CONDITIONS_SHAPE_FUNCTIONS_ONLY_SELECTED_SURFACES ; 
else
