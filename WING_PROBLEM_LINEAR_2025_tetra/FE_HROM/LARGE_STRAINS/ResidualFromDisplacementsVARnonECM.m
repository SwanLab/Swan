function  [VAR,celastST,FgradST,detFgrad,fINTredNON_mst_DOFl,wMSTeq,ResREDeqMST] =  ResidualFromDisplacementsVARnonECM(OPERFE,VAR,MATPRO,DATA,VARint_n,tauNONallDER_q)
%--------------------------------------------------------------------------
...
if isempty(VAR.PK2STRESS) && DATA.INTERNAL_FORCES_USING_precomputed_Kstiff ==0
  ...
  %  [VAR.FINT,fINTredNON_mst_DOFl,Bst_non_q] = InternalForcesECMnon(OPERFE,VAR.PK1STRESS,VAR.PK2STRESS,DATA,VAR,tauNONallDER_q) ;
    % New linearization, 22-July-2025
        [VAR.FINT,fINTredNON_mst_DOFl,wMSTeq,ResREDeqMST] = InternalForcesECMnon2(OPERFE,VAR.PK1STRESS,VAR.PK2STRESS,DATA,VAR,tauNONallDER_q) ;
