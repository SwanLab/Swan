function [g,Grad_g] = LocEvalBasFunAnalytical(xLOC,DATA,VAR_SMOOTH_FE,POLYINFO)
...
[f,df] = feval(DATA.Integrand.NameFunctionGenerate, DATA.xLIM ,xLOC,DATA.Integrand) ;
if ~iscell(df)
    df = {df} ;
end
