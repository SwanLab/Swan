function  [ Ared,RECONS_PK2stress,OTHER_output ]=  HROMCODElargeHOMOG(DATAFILE,PARAMETERS)
% HROM   CODE, large strains, HOMOGENIZATION
% JAHO, 20-JAN-2021  (adaptation of FECODElargeHOMOG)
if nargin ==0
    load('tmp.mat')
end
TIME_COMPUT=[] ;
...
[BasisU,BasisStwo,ECMdata,...
    MESH,MATPRO,OPERHROM,DISP_CONDITIONS,DATAHROM,OTHER_output]  = ...
...
% snapshots )
[DATAHROM,VAR,SNAP] = INITIALIZATIONvarHOMOG(DATAHROM)   ;
%
...
if PARAMETERS.ONLY_PRINT_GID == 0
   [DATAHROM,CONVERGED]=NONLINEARhomogLARGE(DATAHROM,DISP_CONDITIONS,VAR,OPERHROM,SNAP,MATPRO) ;     
else
...
Ared = OPERHROM.Ared  ; 
DATAinpGID = []; 
DATAinpGID.OPERreconstr.DISP.BASIS =  OPERHROM.Ared ; 
DATAinpGID.OPERreconstr.DISP.coeff =  1 ; 

DATAinpGID.OPERreconstr.FLUCT.BASIS =  OPERHROM.Ared ; 
DATAinpGID.OPERreconstr.FLUCT.coeff =  1 ; 
...
DATAinpGID.OPERreconstr.PK2STRESS.coeff =  (OTHER_output.BasisStwoZ'*OTHER_output.BasisStwoZ)\OTHER_output.BasisStwoZ' ; 
RECONS_PK2stress.BASIS = BasisStwo ; 
RECONS_PK2stress.coeff = DATAinpGID.OPERreconstr.PK2STRESS.coeff ; 


DATAinpGID.ADDITION_VARIABLE.DISP = DISP_CONDITIONS.MACROVAR.DISP ;
