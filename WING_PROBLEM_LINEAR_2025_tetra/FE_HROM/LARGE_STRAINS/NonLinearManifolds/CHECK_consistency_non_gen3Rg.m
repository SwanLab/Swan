function CHECK_consistency_non_gen3Rg(NameParamStudyHROM,NAME_BASE,DATALOC,DATALOC1,other_INPUTS)
%==========================================================================
...
load(NAMEOFFLINEstore,'ECMdata','BasisU','DATAoffline','OTHER_output','BasisU_r','BstRED_reactions')
...
%     ylabel('q')
%     for iLAT = 1:size(qL) 
%     h1 = plot(qL(1,:),'DisplayName','Elastic q','LineStyle','--') ;
%     h2 = plot(qL(2,:),'DisplayName','Plastic q') ;
%     end
%     
%     % FE
%     qL_FE = BasisU(:,1:2)'*Kll*DISP_LOC_FE(DISP_CONDITIONS.DOFl,:) ;
%     plot(qL_FE(1,:),'DisplayName','FE Elastic q','LineStyle','--') ;
%     plot(qL_FE(2,:),'DisplayName','FE Plastic q','LineStyle','--') ;
%     legend show;
