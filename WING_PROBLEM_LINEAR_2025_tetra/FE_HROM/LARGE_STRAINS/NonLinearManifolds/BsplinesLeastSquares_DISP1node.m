function [DATA_evaluateTAU_and_DER, nREDcoor] = BsplinesLeastSquares_DISP1node(DATA_interp, qINF, VrightT, UU, SS)
%--------------------------------------------------------------------------
% BsplinesLeastSquares_DISP1node is a modification of
% BsplinesLeastSquares_MAXLOC, described below 
% Goal: use as latent variable the displacement of a single node 
% JAHO, 17-Nov-2025, Balmes 185, Barcelona
%
% BsplinesLeastSquares_MAXLOC is a modification of
% BsplinesLeastSquares_fast, described below. 
% The goal of the modification is to adapt to the case in which 
% there is no "master" mode, but all amplitudes are slave
...
if USE_VECTORIZED_VERSION == 1
    DATA_evaluateTAU_and_DER.nameFunctionEvaluate = 'tauFUN_1paramVECT_max'; % Name of the function
    ...
    qMASTER = [0.5,0.4] ;
    [tau,tauDER1,tauDER2] = tauFUN_1paramVECT_max(qMASTER,DATA_evaluateTAU_and_DER)  ;
