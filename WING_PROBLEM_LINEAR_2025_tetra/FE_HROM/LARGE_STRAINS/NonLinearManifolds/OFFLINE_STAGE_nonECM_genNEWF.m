function OFFLINE_STAGE_nonECM_genNEWF(DATAoffline,DATA_interp,...
    NAME_BASE,DATA_GENGAUSS,InputDataForForces,DATA_interp_ECM)
%--------------------------------------------------------------------------
% OFFLINE_STAGE_nonECM_genNEWF is a modification of
% OFFLINE_STAGE_nonECM_genFASTd, described below. 
% The goal is to adapt it to a formulation in which the decoder is not
% written as the product of some SVD modes times coefficent, but in a more
% general fashion
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/112_NonLIN_ROM_RBF/20_directMHROM.tex.mlx
% JAHO, 17-Nov-2025, Monday, CAmpus Nord UPC, Barcelona 
...
[nREDcoor,Autoencoder] = ConstructAutoencoder(PhiLIN,PhiNON,DATA_interp,qINF,VV',UU,SS,qSUP) ; 
