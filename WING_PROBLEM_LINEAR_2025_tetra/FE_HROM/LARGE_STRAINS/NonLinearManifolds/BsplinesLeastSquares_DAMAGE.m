function [DATA_evaluateTAU_and_DER] = BsplinesLeastSquares_DAMAGE(DATA_interp, qMASTER_nonl, VrightT, UU, SS)
%--------------------------------------------------------------------------
% BsplinesLeastSquares_DAMAGE is a modification of
% BsplinesLeastSquares_PLAST, described below.
% The modification is targeted to adapt it to damage models
...
%DATA_evaluateTAU_and_DER.nameFunctionEvaluate = 'tauFUN_1paramDAMAGE'; % Name of the function
DATA_evaluateTAU_and_DER.nameFunctionEvaluate = 'tauFUN_1paramDAMAGE_v2'; % Version 2
...
DATA_interp = DefaultField(DATA_interp,'IndexLatentNonlinearVariable',2) ;
DATA_evaluateTAU_and_DER.IndexLatentNonlinearVariable = DATA_interp.IndexLatentNonlinearVariable ;
...
disp('Testing tauFUN_1paramDAMAGE_v2')
% qMASTER = [0,0.2
%            -0.2,0.2   ] ;

qMASTER = zeros(DATA_interp.nREDcoor,2) ;
qMASTER(DATA_interp.IndexLatentNonlinearVariable,:) = [-0.2,0.2] ;
[tau,tauDER1,tauDER2] = tauFUN_1paramDAMAGE_v2(qMASTER,DATA_evaluateTAU_and_DER)  ;
