function  [z_mst, z_slv,w_mst,w_slv,DATA_regress_eta_der] = DiscreteECM_adaptWEIGHTSfstNS(A,z,w,DATA_interp,wFE)
% This is a modification of DiscreteECM_adaptWEIGHTSfst, described below
% The goal of the modification is to treat the contribution of all the
% slave points at once (weighted by the integration weights)
% JAHO, 1-Sept-2025, Terrassa, UPC, Barcelona 
...
% In this version, we do not care about the individual contribution of each
% slave point, but only about its weighted effect. Accordingly, in what
% follows, we make
A_slv = w_slv'*A_slv ; 
w_slv = 1; 
