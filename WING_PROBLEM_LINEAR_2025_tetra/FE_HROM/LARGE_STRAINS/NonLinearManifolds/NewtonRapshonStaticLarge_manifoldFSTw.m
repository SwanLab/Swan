function [VAR,CONVERGED,DATA] = NewtonRapshonStaticLarge_manifoldFSTw(DATA,OPERFE,VAR,MATPRO,DOFl)
% NewtonRapshonStaticLarge_manifoldFSTw is a variation of
% NewtonRapshonStaticLarge_manifoldFST, described below
...
while  kiter <=DATA.NEWTON_RAPHSON.NMAXiter
    ...
    if  ~isempty(OPERFE.wSTs_cluster)
        ...
        [w,dw_q]  = feval(OPERFE.wSTs_cluster.DATA_regress.nameFunctionEvaluate,q,OPERFE.wSTs_cluster.DATA_regress) ;
        OPERFE.wSTs = w;
        OPERFE.dw_q = dw_q;
    end
