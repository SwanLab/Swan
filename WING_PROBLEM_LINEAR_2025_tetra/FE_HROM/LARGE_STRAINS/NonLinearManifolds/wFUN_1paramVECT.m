function [w,wDER1,wDER2] = wFUN_1paramVECT(qL,DATA)
if nargin == 0
    load('tmp1.mat')
end
%--------------------------------------------------------------------------
...
% training region
[w,wDER1,wDER2 ] = evaluate_spline_with_extrapolationMAWecmF(DATA.sp, DATA.sp1, DATA.sp2, DATA.xmin,DATA.xmax,DATA.INFO_EXTRAP,qL,DATA.VOL) ;
