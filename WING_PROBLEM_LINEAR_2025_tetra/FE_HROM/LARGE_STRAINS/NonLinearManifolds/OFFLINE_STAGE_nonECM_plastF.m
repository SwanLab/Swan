function OFFLINE_STAGE_nonECM_plastF(DATAoffline,DATA_interp,...
    NAME_BASE,DATA_GENGAUSS,InputDataForForces)
% Modification of OFFLINE_STAGE_nonECM_plast (described below)
% The goal is here is to acommodate cases in which the displacement
% is parametrized with a di
%--------------------------------------------------------------------------
% This is a modification of OFFLINE_STAGE_nonECM_genD2 (described below).
% The goal is to examine whether small strains, plasticity problems with
% just an input parameter (prescribed displacement ) are amenable to be
% described by 2 reduced coordinates: one for "elastic" part of the
% deformation, and another one for the plastic one 
% % JAHO % 9th August 2025, Saturday, Molinos Marfagones, Cartagena,
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/112_NonLIN_ROM_RBF/06_PLAST/06_PLAST.mlx
% ----------------------------------------------------------------------------
% OFFLINE_STAGE_nonECM_genD2, in turn, is a modification of 
