function [setPoints,wRED,ERROR_GLO,DATAOUT] = DiscreteECM_givenAmatr(SNAPfint,DATA,wSTs,DATAoffline,SNAPreact)
% ADaptation of DiscreteECM_givenAmat (described) below to separate
% treatment of internal forces and reactions (SNAPreact)
% JAHO, 9-Oct-2025, 6:14 AM, Balmes 185, Barcelona. 
%--------------------------------------------------------------------------
...
% **********************************
TIMEq = tic ; 
 [Q] = QbasisMatrixIntegrand_givenSNAPr(SNAPfint,DATA,wSTs,DATAoffline,SNAPreact) ; 
