...
TransMatrix = cell(length(BasisU_cluster),1) ; % Matrix for changing from one cluster to   neighboring
% clusters




CONNECTIVITY_CLUSTERS =cell(length(BasisU_cluster),length(BasisU_cluster));
