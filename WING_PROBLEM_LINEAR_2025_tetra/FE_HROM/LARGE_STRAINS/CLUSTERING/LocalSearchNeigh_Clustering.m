function [indCANDIDATES,sortedDISTANCES,indDIST ]= ...
    LocalSearchNeigh_Clustering(ipoints,d,nd,SNAPdisp,IndRest,TolStopSearch,MaxNumberNeighbor,DISTANCES_POINTS)
...
while jpoints <=MaxNumberNeighbor && ERROR_approx > TolStopSearch
    indCANDIDATES = indDIST(1:jpoints) ;
