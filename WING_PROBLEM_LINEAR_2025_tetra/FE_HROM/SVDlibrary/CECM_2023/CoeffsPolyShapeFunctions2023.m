function [COEFFSpol,LelemSCALING,coorREF,POLYINFO] = CoeffsPolyShapeFunctions2023(elemCONTAINER,NODESloc,VAR_SMOOTH_FE,POLYINFO)
...
if ~isempty(POLYINFO.COEFFSpolynomial{elemCONTAINER})
   ...
   % ireferenceCOOR = 1;
    ...
    coorREF  = sum(COORelement,1)/size(COORelement,1) ; %15-Nov-2022
