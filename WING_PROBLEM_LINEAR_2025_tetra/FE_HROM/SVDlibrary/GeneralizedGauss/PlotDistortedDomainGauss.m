function PlotDistortedDomainGauss(DATAOUT_irreg_gauss,DATAOUT_gauss,wGAUSS,xGAUSS,VSinv,DATALOC,xMAT,errorGAUSS,w_gauss_q)
...
if  ~isempty(DATAOUT_irreg_gauss)
    ...
    xBORDER = [xxVAR,yyFIXmin
              xxFIXmax,yyVAR
              xxVAR(end:-1:1),yyFIXmax
              xxFIXmin,yyVAR(end:-1:1)] ; 
    ...
    EvaluateBasisFunctionAtX(xBORDER,VSinv,DATALOC,EVALUATE_GRADIENT,EVALUATE_FUN) ; 
     ...
     plot(DATAOUTloc.COORdistorted(:,1),DATAOUTloc.COORdistorted(:,2),'r')  ;
