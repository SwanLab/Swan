function Plot2DpointsCECMgen(DATALOC,xDECM,xCECM,xINITIAL,wCECM,wDECM,zCECM,DATAadd,DATAapprox,zDECM)
...
%     end
h(1) = plot(xDECM(:,1),xDECM(:,2),'.','Color',[0 0 1],'MarkerSize',8);
h(2) = plot(xCECM(:,1),xCECM(:,2),'x','Color',[1 0 0],'MarkerSize',8);
...
if isfield(DATAadd,'wGAUSS')
    h(4)  = plot(DATAadd.xGAUSS(:,1),DATAadd.xGAUSS(:,2),'o','Color',[0.5,0.5,0],'Markersize',8) ;
