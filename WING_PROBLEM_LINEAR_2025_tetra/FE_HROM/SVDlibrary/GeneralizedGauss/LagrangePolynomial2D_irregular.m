function  [A, dA_x,dA_y,DATAOUT ]=    LagrangePolynomial2D_irregular(xLIM,P,xMAT,DATA)
% See comments in LagrangePolynomial2D_irregular_aux.mlx
if nargin == 0
    load('tmp1.mat')
end
...
for  idim = 1:ndim
    ...
    for jpoints = 1:npointsE
        for kdim = 1:ndim
            J(idimLOC,kdim) = J(idimLOC,kdim) + X(idim,jpoints)*B{kdim}(ipoints,jpoints) ;
        end
    end
end
