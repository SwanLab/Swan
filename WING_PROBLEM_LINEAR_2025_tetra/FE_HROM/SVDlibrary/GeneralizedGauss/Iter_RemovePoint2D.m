function [xNEW,wNEW,CONVERGENCE,DATALOC] = Iter_RemovePoint2D(xNEW,wNEW,xINT,PHI,PHI_der,b,DATALOC,...
    VSinv)
...
S_crit = CriterRemovePoints(DATALOC,wNEW,PHIk_y,b,PHI_der,xNEW,xINT);
...
while SALIR == 0 & iremove <=size(xOLD,1)
    ...
    while  nF>=TOL & k<= kMAX & nITER_increase<=maxITER_increase
        ...
        % dbstop('74')
        [xkp1 wkp1 nF ISNEGATIVE  ] = IterNR_GAussian2D(wNEW,PHI,b,xNEW,PHI_der,xINT,VSinv,DATALOC) ;
        nF = nF/normB ;
