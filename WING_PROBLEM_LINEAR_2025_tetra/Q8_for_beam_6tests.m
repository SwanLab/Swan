function [DATAOUT] = Q8_for_beam_6tests(AMPLITUDE_alltests,DATAOUT,index_SURFACES_END_BEAMS)
...
% 
% itest = 8 ; 
% index_SURFACES_END_BEAMS_REVERSE = [index_SURFACES_END_BEAMS(2),index_SURFACES_END_BEAMS(1)] ; 
%   INPUTS_PARAMETERS(itest).DIRICHLET =  DirichBound_BEAM_generic(DATAOUT.t0,DATAOUT.tEND,AMPLITUDE(:,7),index_SURFACES_END_BEAMS_REVERSE)  ;
%     INPUTS_PARAMETERS(itest).TypeFunctionDisplacementTRAINING = 'RIGID_BODY_WARPING_ON_SURFACES'; %
%     INPUTS_PARAMETERS(itest).NEUMANN = [] ;
