classdef Isotropic_MBB_LevelSet < handle
    ...
    methods (Access = public)
        ...
        function obj = Isotropic_MBB_LevelSet()
            obj.init()
            obj.createMesh();
            ...
            obj.createOptimizer();
            obj.designVariable.fun.print('fValues_Isotropic_LevelSet_MBB');
        end
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            s.etaMaxMin      = 0.01;
            s.gif            = true;
            s.gifName        = 'MBB_Isotropic_LevelSet';
            s.printing       = false;
