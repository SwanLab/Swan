...
s.benchmark.bcValues = [0:1e-4:1e-2,1e-2:1e-5:5e-2];%[0:1e-4:5e-3,5e-3:1e-4:2e-1];%[5e-3:0.1*1e-3:1e-2];%;%[0:1e-4:1e-1];
s.matInfo.E  = 210;
s.matInfo.nu = 0.3;
s.matInfo.Gc = 2.7e-3;
...
save("SEN1e-5_0.0075_1e-12.mat","outputData") %ACTIVATE TO SAVE DATA!
