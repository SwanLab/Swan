...
s.matInfo.degradationType = 'PhaseField';
s.matInfo.degradationSubType = 'IsoHomog'; 
...
% save("1ElemAT1_v3.mat",'outputData')
% 
...
% outputData = tester.compute();
% outputData.inputParameters = s;
% save("1ElemAT2_v3.mat",'outputData')
% 
...
% outputData = tester.compute();
% outputData.inputParameters = s;
% save("1ElemRational01_v3.mat",'outputData')
% 
% s.matInfo.degradationSubType = 'General'; 
% s.l0 = 0.05; 
% s.matInfo.params.coeffs = [(4/pi)*(s.matInfo.Gc*s.matInfo.young)/(s.matInfo.sigmaMax^2 * s.l0), -0.5]; 
...
% outputData = tester.compute();
% outputData.inputParameters = s;
% save("1ElemRational005_v3.mat",'outputData')
% 
