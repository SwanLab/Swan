...
PFH = PhaseFieldHomogenizer(s);
[mat,phi,holeParam] = PFH.computeHomogMaterial();
save("PhaseFieldExperiments/PFVademecum/Degradation/HexagonArea","mat","phi","holeParam")
...
% PFH = PhaseFieldHomogenizer(s);
% [mat,phi,holeParam] = PFH.computeHomogMaterial();
% save("PhaseField/PFVademecum/Degradation/HexagonPerimeter","mat","phi","holeParam")
