classdef FilterPDEDirichletFixed < handle
    ...
    methods (Access = public)
        function obj = FilterPDEDirichletFixed(cParams)
            obj.init(cParams);
    ...
    methods (Access = private)
        ...
        function computeLHS(obj)
            ...
            Mgam = IntegrateLHS(@(u,v) obj.gamma.*obj.isFixed.*DP(u,v),vF,uF,obj.mesh,'Domain');
            obj.LHS = decomposition(lhs+Mgam);
        end
        ...
        function computeRHS(obj,fun,quadType)
            ...
            Fgam = IntegrateRHS(@(v) DP(obj.gamma.*obj.isFixed,v),obj.trial,obj.trial.mesh,'Domain',quadType);
            obj.RHS = obj.bc.fullToReducedVector(rhs+Fgam);
        end
