classdef PlotterDensity < handle
    ...
    methods (Access = private)
        ...
        %     ax = gcf().Children;
        %     obj.patchHandle = patch(ax, 'Faces', obj.mesh.connec, ...
        %         'Vertices', obj.mesh.coord, ...
        %         'EdgeColor', 'none', 'LineStyle', 'none', ...
        %         'FaceLighting', 'none', 'AmbientStrength', .75);
        %     colormap(PlotterDensity.redtoblue())  % <-- chama método estático
        %     colorbar
        % end
