classdef OptimizerMMA_symmetry < Optimizer
    ...
    methods (Access = public)
        ...
        function obj = OptimizerMMA_symmetry(cParams)
    ...
    methods (Access = private)
        ...
        function init(obj,cParams)
            ...
            if isfield(cParams, 'applySymmetry')
                ...
                obj.applySymmetry = false; % OptimizerMMA no imponia simetria hasta ahora; false preserva el comportamiento previo por defecto
            end
