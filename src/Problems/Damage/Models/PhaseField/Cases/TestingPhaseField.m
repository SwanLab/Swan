        ...
        function createMaterialPhaseField(obj)
            ...
            switch obj.matInfo.matType
                case {'Analytic','AnalyticSplit'}
                    ...
                    [mu,dmu,d2mu] = PhaseFieldDegradationInterpolator.compute(obj.matInfo.degradationType,mu0);
                    [k,dk,d2k]    = PhaseFieldDegradationInterpolator.compute(obj.matInfo.degradationType,k0);
                    obj.mat.mu = mu; obj.mat.dmu = dmu; obj.mat.d2mu = d2mu;
                    obj.mat.k  = k;  obj.mat.dk  = dk;  obj.mat.d2k  = d2k;

                    if strcmp(obj.matInfo.matType,'Analytic')
                    ...
                    elseif strcmp(obj.matInfo.matType,'AnalyticSplit')
