...
% Optional: average major and minor symmetry explicitly
Ainv = 0.5*(Ainv + permute(Ainv,[3 4 1 2])); % major symmetry
Ainv = 0.25*(Ainv + permute(Ainv,[2 1 3 4]) + permute(Ainv,[1 2 4 3]) + permute(Ainv,[2 1 4 3])); % minor
