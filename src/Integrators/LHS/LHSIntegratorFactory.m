        ...
        function obj = create(cParams)
            switch cParams.type
                ...
                case 'StiffnessFiniteStrain'
                    if isa(cParams.test,'LagrangianFunction')
                        obj = LHSIntegratorStiffnessFiniteStrain(cParams);
                    elseif isa(cParams.test,'ModalFunction')
                        obj = LHSIntegratorStiffnessFiniteStrainModal(cParams);
                    end                    
                case 'StiffnessFiniteStrainModal'
                    obj = LHSIntegratorStiffnessFiniteStrainModal(cParams);
