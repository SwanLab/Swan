classdef DiagonalCoordComputer < TotalCoordinatesCalculator
    ...
    methods (Access = private)
        ...
        function placeCentralNode(obj)
            ...
            if ~isempty(obj.latticeVectors) && size(obj.latticeVectors, 1) == 3
                
                v1 = obj.latticeVectors(1,:);
                v2 = obj.latticeVectors(2,:);
                v3 = obj.latticeVectors(3,:);
        ...
        function obtainMasterCoord(obj, newVert)
            ...
            for iMaster = 1:nsides/2
                ...
                if ~isempty(obj.latticeVectors)
                    ...
                    targetLen = norm(v) / obj.diagDiv;  
                    
                    currentLen = norm(vertB - vertA) / obj.div_aux(iMaster);
                    while currentLen > targetLen + 1e-12 && obj.div_aux(iMaster) < obj.diagDiv * 2
