classdef TopOptTestTutorialDensityNullSpace_Arch < handle
    ...
    methods (Access = public)
        ...
        function obj = TopOptTestTutorialDensityNullSpace_Arch()
            obj.init()
            obj.createMesh();
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            opt.solveProblem();
            obj.optimizer = opt;
            obj.designVariable.fun.print('Density_Arch'); %Guarda la simulació automàticament per poder veure-la després a paraview
        end
