classdef SuperformulaDbFEMElasticityMicro < handle
    ...
    methods (Access = public)
        ...
        function obj = SuperformulaDbFEMElasticityMicro(gPar)
            obj.gPar = gPar;
            obj.createMesh();
    ...
    methods (Access = private)
        ...
        function createMesh(obj)
            ...
            if obj.gPar.semiHorizontalAxis ~= 0 && obj.gPar.semiVerticalAxis ~= 0

                uMesh = UnfittedMesh(sUm);
                ls = obj.computeSuperformulaLevelSet(fullmesh);
                uMesh.compute(ls);
        ...
        function ls = computeSuperformulaLevelSet(obj, mesh)
            obj.gPar.type        = 'Superformula';
