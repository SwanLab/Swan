...
for n = 1:length(N)
    ...
    % Convert cells to block H-Matrix and vectors
    tic
    G      = bmm({G{1} G{4} G{5} ; G{4} G{2} G{6} ; G{5} G{6} G{3}});
    T      = bmm({T{1} T{4} T{5} ; T{4} T{2} T{6} ; T{5} T{6} T{3}});
    C      = bmm({C{1} C{4} C{5} ; C{4} C{2} C{6} ; C{5} C{6} C{3}});
