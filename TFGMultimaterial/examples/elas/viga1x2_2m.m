function [mesh, pdecoef, matprop, params, bc, psi] = viga1x2_2m
...
%% parameters
    ...
    % penalty parameter
    params.penalty = [2.0];   % method 1,2 and 3
    params.volfrac = [0.2];   % method 2 and 3
    params.voleps  = [0.01];  % method 2 and 3
    params.auglag  = [1.25];   % method 3
    ...
    prec = 1e6;
    n = 40;
    [p,e,t] = poimesh(g,1*n,2*n); %p1 = round(prec*p1)/prec; 
    t(4,:) = 1; 
