function [mesh, pdecoef, matprop, params, bc, psi] = symmetry_cog_3m
    %% load g and b 
    ...
    params.volfrac = [0.3 0.3];   % method 2 and 3
...
%-------------------------------------------------------------------------%
    ...
    ldir3 = [0,0,cx,0];
    ldir4 = [0,0,0,cy];
    ldir = [repmat(ldir1,3,1);repmat(ldir2,3,1);ldir3;ldir4];
    
    ldof1 = [1,1];
    ldof2 = [1,2];
    ldof3 = [1,3];
    ldof = [repmat([ldof1;ldof2;ldof3],2,1);ldof2;ldof3];
    
    lval = zeros(size(ldof));
