function [mesh, pdecoef, matprop, params, bc, psi] = symmetry_cog_2m_mod
    %% load g and b 
...
%-------------------------------------------------------------------------%
    ...
    cx2_i = 0.5; cy2_i = 0.0;
    cx2_f = 2.0; cy2_f = 0.0;
    ldir1 = [cx1_i,cy1_i,cx1_f,cy1_f];
    ldir2 = [cx2_i,cy2_i,cx2_f,cy2_f];
    ldir = [ldir1;ldir2];
    ldof = [1,1;
            1,1];    
    lval = -1000*ones(size(ldof));
