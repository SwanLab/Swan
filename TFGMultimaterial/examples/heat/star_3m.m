function [mesh, pdecoef, matprop, params, bc, psi] = star_3m
    ...
    params.volfrac = [0.75*0.5 0.75*0.5];   % method 2 and 3
    params.voleps  = [0.01 0.01];  % method 2 and 3
    params.auglag  = [0.02 0.02];   % method 3
...
%     ldir = [cx(:,1),cy(:,1),cx(:,2),cy(:,2)];
%     ldof = ones(4,2);
%     lval = zeros(4,1); lval(end-1:end)=100;
