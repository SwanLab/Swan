classdef CoarseTesting_Hole < handle
    ...
    methods (Access = public)
        ...
        function obj = CoarseTesting_Hole()
            close all
            obj.init()
    ...
    methods (Access = private)
        ...
        function init(obj)
            ...
            obj.fileNameCoase = fullfile('AlbertTFG files', 'mat files', 'Hole','UL_r0_1-20x20-Hole.mat');
         ...
         function Mcoarse = createCoarsePreconditioner(obj,mR,dir,iC,lG,bS,iCR,dMesh)
            ...
            for i=1:obj.nSubdomains(1,2)
                for j=1:obj.nSubdomains(1,1)
                    s.RVE{i,j}           = CoarseTrainedRVE(filename);  %%Passar vector de filenames
                end
            end
