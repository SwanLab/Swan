function [OPERFE,Nst,wSTs_RHS,NstT_W_N_boundaries,ngaus_RHS,GEOproperties,MESH,DATA] = ...
    GeometricMatricesFun_EIFEbubCOROT(MESH,nstrain,PROPMAT,DATA)
% Matrices depending on the finite element mesh (i.e., that can be pre-computed)
% Adaptation of GeometricMatricesFun_EIFEbub.m  for  EIFEM COROTATIONAL
% FORMULATION
% ----------------------------------------------------------------------------
% JAHO - 22-oct-2024, Tuesday,  Balmes 185, Barcelona 
...
[OPERFE.D_BmatIst,Nmat_allelem,WEIGHTSinteg,TRANSF_COORD,MESH.CN,DATA,OPERFE.D_KcLINloc,MESH.CN_SUPPORT,OPERFE.QrotINI,OPERFE.lambdaLEN,OPERFE.D_Wecm,...
    OPERFE.INDEXsparseROTmat,OPERFE.LboolCall,OPERFE.XcALL,OPERFE.D_PdownsRB  ]=...
    B_N_matricesEIFEbubCOROT(MESH.COOR,MESH.CN, PROPMAT,MESH.MaterialType,DATA,MESH.TypeElement,CN_SUPPORT ) ;
