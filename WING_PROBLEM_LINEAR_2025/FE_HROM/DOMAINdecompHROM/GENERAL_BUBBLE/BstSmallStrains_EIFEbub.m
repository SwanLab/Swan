function Bst_F= BstSmallStrains_EIFEbub(MESH,nstrain,Bmat_all)
% Adaption  Bst_F= BstSmallStrains_EIFE.m to bubble modes
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/104_EIFEM_plast2D/04_GeneralTheory.mlx
% JAHO, 3-Oct-2023, UPC, Terrassa/13-Oct-2023, Buenas Migas (Diag.), Barcelona 
if nargin ==0 
    load('tmp1.mat')
end
