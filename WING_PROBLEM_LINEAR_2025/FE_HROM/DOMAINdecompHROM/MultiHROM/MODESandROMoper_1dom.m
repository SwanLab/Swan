function [PhiDEF,PsiDEFf,Vall,Mintf,Mdom,PhiRB,PsiRBf,MESH,DATA,FluctuationFacesGLO] ...
    = MODESandROMoper_1dom(OPERFE,MESH,DATA,SNAPreact,BasisStwo,...
...
% 
[Vall,MESH,DATA,~,FluctuationFacesGLO] = FictInterfaceDISP(PhiDEF,PsiDEFf,MESH,DATAcommon,DATA,Mintf,PhiRB,PsiRBf,DATAoffline);
