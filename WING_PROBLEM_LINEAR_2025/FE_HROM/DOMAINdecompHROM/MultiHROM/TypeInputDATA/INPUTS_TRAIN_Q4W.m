function [MESH,MATPRO,OPERFE,Fbody,Ftrac,DISP_CONDITIONS,INICOND,DATA,OTHER_output] =  INPUTS_TRAIN_Q4W(DATAINPUT)
...
DATAINPUT  = DefaultField(DATAINPUT,'TILED_MESH',[]);  % Mesh constructed as tiled copies of a given RVE
% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/109_EIFEM_largeROT/13_auxALEX.mlx
DATA.TILED_MESH = DATAINPUT.TILED_MESH ; 
...
% --------------------------------------------------------------
DATAINPUT = DefaultField(DATAINPUT,'typePROBLEM','pstrain') ; 
DATAINPUT = DefaultField(DATAINPUT,'MESHcoarse',[]) ; 

if isempty(DATAINPUT.MESHcoarse)
...
DATAINPUT = DefaultField(DATAINPUT,'LabelEntitiesDefiningBoundary',[]) ; 
