function [Vall,Mintf,MESH,DATA] = prueba(PhiDEF,PsiDEFf,MESH,DATAcommon,DATA,Mintf,PhiRB,PsiRBf,DATAoffline)
...
COOR = 2*MESH.COOR ; 
[Nshape, ~,~ ]=    ShapeFunctionFE(xLIM,COOR,DATAlocSHAPE) ;
...
for innode = 1:size(Nshape,2)
    ...
    PlotModesDEF_SubdomainLevel(DATA,Vrb,MESH)
