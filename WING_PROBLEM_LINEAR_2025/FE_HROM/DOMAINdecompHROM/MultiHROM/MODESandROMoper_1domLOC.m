function [PhiDEF,PsiDEFf,Vall,Mintf,Mdom,PhiRB,PsiRBf,MESH,DATA] ...
    = MODESandROMoper_1domLOC(OPERFE,MESH,DATA,SNAPreact,BasisStwo,...
...
[PsiDEFf,MintfINV] =   SelfEquilibratedModes_1domLOC(MESH.faceDOFSall,PsiRBf,Mintf,SNAPreact,DATA)  ;
