function  [Tdd, c, s,INDrig,INDdef,T]=  AssemblyTreacTILING2D3D(BasisRdef,NODESbound,reactDOMrbGLO,betaBC,COL,COLloc,...
    THETAfaces,GAMMAentities,ndim,alphaBC,r,BasisRrb)
