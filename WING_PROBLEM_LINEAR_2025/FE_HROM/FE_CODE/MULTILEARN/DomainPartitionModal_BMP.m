...
addpath('FE_CODE') ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
INPUT_DATAFILE  = {'DATA_BEAMsolid'} ; {'DATA_BEAMporousBEND'}; {'DATA_BEAM_Hexa2D_D6_bend'} ; {'DATA_BEAMporousBEND'};;{'DATA_BEAMsolidENA_otherEND'} ; {'DATA_BEAMsolidENA','DATA_BEAMsolidENA_otherEND'} ; {'DATA_BEAM_Hexa2D_D6_bend'} ;  'DATA_BEAM_Hexa2D_bend' ;  % MACRO-STRUCTURE
INPUT_DATA_RVE = [];
NROWS = [4] ;
NCOLS = [20] ;
ROWS =  { };
...
DATA.NMODES_TRUNCATE = [3] ;   % Number of modes for truncation
%
% INCLUDE_MODES_RVE = 0 ;
COORrve = {} ;
CNrve = {}  ;
...
%     
    ...
    dRECONS = SNAP_recontru ; %+ RIGID_BODY_MOTIONglo ;
