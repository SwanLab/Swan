function  [T, c, s]=  AssemblyTreacNEW(BasisRdef,f1,f2,nDOM,reactDOMrb,ALPHA)
...
for idom = 1:nDOM
    if idom == 1
        if nDOM >1
            indROWS = 1:nMODES ;
            indCOLS = 1:2*nMODES ;
            T(indROWS,indCOLS) = [(1-ALPHA(1))*Cov_f1f1 +  Cov_f2f2, Cov_f2f1] ;
            ...
            indROWS = 1 ;
            indCOLS = 1;
            T(indROWS,indCOLS) = [(1-ALPHA(1))*Cov_f1f1 + (1-ALPHA(end))*Cov_f2f2] ;
            c(indROWS) =(1-ALPHA(1))*(reactDOMrb{idom}(f1,:) )'*BasisRdef(f1,:) + ...
    ...
    elseif idom == nDOM
        ...
        T(indROWS,indCOLS) = [Cov_f1f2, Cov_f1f1+ (1-ALPHA(end))*Cov_f2f2] ;
