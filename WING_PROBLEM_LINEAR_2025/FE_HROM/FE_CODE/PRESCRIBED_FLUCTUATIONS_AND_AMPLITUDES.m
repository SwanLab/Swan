% See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/105_BackPeriodic/02_LAST_EXPLORATION.mlx 
%load('tmp1.mat')
DATAcoarsefine = [] ;
...
Ufluctuations = INPUTS_LOC.Ufluctuations ; % Fluctuations 
...
if OKK ==1
    ...
    if isempty(ROTMATRIX)
        % Straight domains
        [Gb,dR,DOFr,DOFm,AREA,R,DOFA,DOFB] = PRESCRIBED_FLUCTUATIONS_AND_AMPLITUDESfun(a_A,a_B,DOMAINVAR,COOR,CONNECTb,TypeElementB,...
