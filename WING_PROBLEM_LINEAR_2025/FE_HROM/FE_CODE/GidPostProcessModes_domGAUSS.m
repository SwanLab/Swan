function MSG = GidPostProcessModes_domGAUSS(COOR,CN,TypeElement,MODES,posgp,NameFileMesh,DATA,WHICHMODE,MSG);
...
MODESplot = MODES ;
%end
GidResults2DFE_modesGAUSS(NameFile_res,COOR,CN,TypeElement,MODESplot,posgp,DATA);
