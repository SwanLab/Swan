function  [DOFr DOFm G dR dispMACRO DATA] = MINIMAL_KBCS_HEXAGm2D(COOR,CN,MACRODEF,CNb,DATA,TypeElementB)
...
for iline =1:length(NODESln)
    NODESpnt = [NODESpnt; NODESln{iline}(1)] ; 
end
...
[DOFr,DOFm,G,dR,dispMACRO] =     MasterSlavesMin(NODESln,NODESpnt,CNb,COOR,TypeElementB,MACRODEF,DATA)  ;
%%%%%%%%%%%%%%%%%%%%%%%%%
