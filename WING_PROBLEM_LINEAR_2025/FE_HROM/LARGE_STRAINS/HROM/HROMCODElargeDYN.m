function  [BasisUall,RECONS_PK2stress,OTHER_output ]=  HROMCODElargeDYN(DATAFILE,PARAMETERS)
...
if PARAMETERS.ONLY_PRINT_GID == 0
    if DATAHROM.ISDYNAMIC == 0
        [DATAHROM,CONVERGED]=NONLINEARstaticLARGE(DATAHROM,DISP_CONDITIONS,VAR,OPERHROM,SNAP,Fbody,Ftrac,MATPRO) ;
    else
