function  ECMdata = CECM_based_ManifAdWeights_PL(A,DATA,Wfe,DATA_interp,zINI,wINI,...
...
while   length(iCAND) > max_nmodes    
    ...
    [wADAPT,iCAND,jELIM,kLOC] = Loop_MAWecmNOENF_cl(U,ilocPOS,iCAND,wADAPT,b,icluster,indSORT,jELIM);  
