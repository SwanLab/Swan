function [DIRICHLET] = DirichBound_BEAM_generic(t0,tEND,AMPLITUDE,SURFACES)
...
DIRICHLET(icond).PRESCRIBED_DISP(iloadstate).AMPLITUDE = [0,0,0,0,0,0,0] ;  % % Translation (centroid face)
