function MESH = GeometryMeshUNC(DATA,OTHERINPUTS)
% Enhanced version of GeometryMesh.m. It is able to deal with "uncoupled"
% meshes
% SEe /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/107_EIFEM_plast3D/06_UNCOUPLED.mlx
% JAHO, 23-APr-2024, Honest Greens, Tuset, Barcelona
...
% WRITTEN IN DIFFERENT MODULESGeometryMesh
...
if isempty(DATA.NameFileMeshDATA)  
    MESH = DATA.MESH_GIVEN ; % 1D 
else
...
if DATA.MERGE_ELEMENTS_MESHES_UNCOUPLED_EIFEM == 1
    % 23-Apr-2024, 
    % See /home/joaquin/Desktop/CURRENT_TASKS/MATLAB_CODES/TESTING_PROBLEMS_FEHROM/107_EIFEM_plast3D/06_UNCOUPLED.mlx
     MESH = MergeMeshUncoupledEIFEM(MESH,OTHERINPUTS.DATAcommon) ; 
end
