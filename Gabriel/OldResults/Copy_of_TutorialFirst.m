classdef TutorialFirst < handle
    ...
    methods (Access = private)
        ...
        function createCost(obj)
            ...
            % s.shapeFunctions{2} = obj.createFilterRegularization();
            s.weights           = 1;
       ...
       function createPrimalUpdater(obj)
        ...
        function m = createMaterial(obj)
            ...
            f_regularized = obj.filterRegularization.compute(f_filtered, 2);

            s.density  =  f_regularized; 
            s.type     = 'HomogenizedMicrostructure';
            s.mesh     = obj.mesh;
            s.young    = 1.0;
            s.fileName = 'HomogenizationLattice1';
            m = MaterialFactory.create(s);
        end
