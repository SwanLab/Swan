classdef Tutorial05_15_Bridge < handle
    ...
    methods (Access = public)
        ...
        function obj = Tutorial05_15_Bridge()
    ...
    methods (Access = private)
        ...
        function createDesignVariable(obj)
            s.fHandle = @(x) 0.22*ones(size(x(1,:,:)));
            s.ndimf   = 1;
            s.mesh    = obj.mesh;
        ...
        function bc = createBoundaryConditionsLoadBased(obj, gdi_index)
            ...
            isRight =@(coor) coor(:,1) >= obj.width-1e-8;
            ...
            isSurface =@(coor) coor(:,2) >= 0.97*obj.height;

            sPL{1}.domain = isSurface;
            sPL{1}.direction = [2];
            sPL{1}.value = -1;
