classdef Tutorial05_15_Steering2_mma_full < handle
    ...
    methods (Access = public)
        ...
        function obj = Tutorial05_15_Steering2_mma_full()
                
                obj.Kp_bar_vector = [0.0005, 0.0003, 0.0001];
                obj.width = 1;
                obj.height = 1;
    ...
    methods (Access = private)
        ...
        function printFinalDisplacement_v3(obj)
            ...
            namePrint = sprintf('SteeringH_FinalDispl_J_%g',num_case);
            uFun = obj.physicalProblemLoadBased{1}.uFun;
