classdef EIFEMbase < handle
    ...
    methods (Access = public)
        ...
        function obj = EIFEMbase(cParams)
            obj.init(cParams)
            LHS = obj.computeLHS();
            obj.LHS = LHS;
...
%             obj.plotSolution(uCoarse,obj.mesh,100,1,obj.iter,0)
    ...
    methods (Access = private)
        ...
        function init(obj,cParams)
            ...
            obj.RVE     = cParams.RVE;
            obj.Kel = repmat(obj.RVE.Kcoarse,[1,1,obj.mesh.nelem]);  %Convert to one long strip and force-fold into 3D
