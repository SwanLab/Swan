classdef Density3DExampleGiD2x2x2Isotropic < handle
    ...
    methods (Access = public)
        ...
        function obj = Density3DExampleGiD2x2x2Isotropic(pRelTar)
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,['LocalResults/MonitoringDensity2DExample4x4Circle',num2str(pRelTar),'.fig']);
            obj.designVariable.fun.print(['LocalResults/Density2DExample4x4Circle',num2str(pRelTar),'fValues']);
        end
