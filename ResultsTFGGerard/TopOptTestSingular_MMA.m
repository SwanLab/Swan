classdef TopOptTestSingular_MMA < handle
    ...
    methods (Access = public)
        ...
        function obj = TopOptTestSingular_MMA()
            obj.init()
            obj.createMesh();
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            opt.solveProblem();
            obj.optimizer = opt;
            obj.designVariable.fun.print('Density_MMA_PecaMassisa2'); %Guarda la simulació automàticament per poder veure-la després a paraview
        end
