classdef GrippingDensityMinNSACompliance < handle
    ...
    methods (Access = public)
        ...
        function obj = GrippingDensityMinNSACompliance()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'NumericalExperiments/Gripping/MonitDensityMinNSACompliance.fig');
            save('NumericalExperiments/Gripping/DesVarDensityMinNSACompliance.mat','d');
        end
