classdef GrippingDensityLocalCirlceDomains < handle
    ...
    methods (Access = public)
        ...
        function obj = GrippingDensityLocalCirlceDomains(epsOverh,tar)
            obj.init(epsOverh,tar)
            obj.createMesh();
