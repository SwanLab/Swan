classdef CantileverDensityMinCompliance < handle
    ...
    methods (Access = public)
        ...
        function obj = CantileverDensityMinCompliance()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'NumericalExperiments/CantileverBeam/MonitDensityMinCompliance.fig');
            save('NumericalExperiments/CantileverBeam/DesVarDensityMinCompliance.mat','d');
        end
