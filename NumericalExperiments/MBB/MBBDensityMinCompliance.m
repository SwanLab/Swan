classdef MBBDensityMinCompliance < handle
    ...
    methods (Access = public)
        ...
        function obj = MBBDensityMinCompliance()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'NumericalExperiments/MBB/MonitDensityMinCompliance.fig');
            save('NumericalExperiments/MBB/DesVarDensityMinCompliance.mat','d');
        end
