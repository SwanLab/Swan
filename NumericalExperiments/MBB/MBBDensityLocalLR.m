classdef MBBDensityLocalLR < handle
    ...
    methods (Access = public)
        ...
        function obj = MBBDensityLocalLR()
            obj.init()
            obj.createMesh();
            ...
            saveas(gcf,'NumericalExperiments/MBB/MonitDensityLocalLR.fig');
            save('NumericalExperiments/MBB/DesVarDensityLocalLR.mat','d');
        end
