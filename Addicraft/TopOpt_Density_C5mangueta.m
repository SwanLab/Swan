classdef TopOpt_Density_C5mangueta < handle
    ...
    methods (Access = public)
        ...
        function obj = TopOpt_Density_C5mangueta(vTar)
            filename = 'C5_Mangueta';
            obj.init()
    ...
    methods (Access = private)
        ...
        function createRBE3Meshes(obj,fName)
            for i=1:10
                run(fName);
                rollerRowsEl = External_border_elements(:,1)==i;
                rollerRowsN  = External_border_nodes(:,1)==i;
