classdef MBBSimulations < handle
...
%             obj.filter.updateEpsilon(epsilon);
        ...
        function bc = createBoundaryConditions(obj)
            ...
            isDirLeft = @(coor) abs(coor(:,2)) == 0 & abs(coor(:,1)) >= 0 & abs(coor(:,1)) <= 0.3;


            isDirRight = @(coor) abs(coor(:,2)) == 0 & abs(coor(:,1)) >= 5.7 & abs(coor(:,1)) <= xMax;
