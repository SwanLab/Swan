...
% sDir{1}.domain    = @(coor) isLeft(coor) | isRight(coor) | isBottom(coor);
% sDir{1}.direction = [1,2];
% sDir{1}.value     = 0;
% 
% 
% sDir{1}.domain    = @(coor) isTop(coor) & not(isLeft(coor) | isRight(coor));
% sDir{1}.direction = [1,2];
% sDir{1}.value     = [1,0];
...
velocityBC.value  = 1; % Velocitat a les vores
