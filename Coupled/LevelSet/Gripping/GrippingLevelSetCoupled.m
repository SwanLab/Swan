classdef GrippingLevelSetCoupled < handle
    ...
    methods (Access = public)
        ...
        function obj = GrippingLevelSetCoupled(eta)
            obj.init(eta)
            obj.createMesh();
            ...
            saveas(gcf,['Coupled/LevelSet/Gripping/Monit',info,'.fig']);
            save(['Coupled/LevelSet/Gripping/DesVar',info,'.mat'],'d');
        end
    ...
    methods (Access = private)
        ...
        function createPerimeter(obj)
            ...
            s.target = max(0,(PMax/L^2)*(l^2-l0^2)) + 0.004*1.25;
