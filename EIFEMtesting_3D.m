classdef EIFEMtesting_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = EIFEMtesting_3D()
            ...
            set(gca, 'YScale', 'log')
            legend({'CG + ILU-EIFEM-ILU','CG+ILU'},'FontSize',12)
            xlabel('Iteration')
            ylabel('Residual')
            title('Residual')
            ...
            set(gca, 'YScale', 'log')
            legend('CG + EIFEM+ ILU(CG-90%-L2)','CG+ILU')
            xlabel('Iteration')
            ylabel('||error||_{L2}')
            title('errPCG')
    ...
    methods (Access = private)
        ...
        function init(obj)
            obj.nSubdomains  = [15 1 1]; %nx ny
            obj.fileNameEIFEMmesh = 'DEF_Q8_wing_1.mat';
            obj.fileNameEIFEM = 'AirfoilTraining_Oversampling15_V2.mat';
        ...
        function cMesh = createReferenceCoarseMesh(obj,mR)
            ...
            % connec = [1 2 5 6 3 4 8 7];
            connec = [4 1 2 3 8 5 6 7];
