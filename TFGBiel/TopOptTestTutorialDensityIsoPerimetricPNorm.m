classdef TopOptTestTutorialDensityIsoPerimetricPNorm < handle
    ...
    methods (Access = public)
        ...
        function obj = TopOptTestTutorialDensityIsoPerimetricPNorm(p,C)
            ...
            vtuName = fullfile(fileLocation, sprintf('Topology_Cantilever_isoperimeter_p%d_C%.2f_gJ2_eta0.02',p,C));
            obj.designVariable.fun.print(vtuName);
            
            figure(2)
            set(gcf, 'Position', get(0, 'Screensize'));
            fileName1 = fullfile(fileLocation, sprintf('Monitoring_Cantilever_isoperimeter_p%d_C%.2f_gJ2_eta0.02.fig',p,C));
            fileName2 = fullfile(fileLocation, sprintf('Monitoring_Cantilever_isoperimeter_p%d_C%.2f_gJ2_eta0.02.png',p,C));
            savefig(fileName1);
