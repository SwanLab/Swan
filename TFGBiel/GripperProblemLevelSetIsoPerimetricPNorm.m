classdef GripperProblemLevelSetIsoPerimetricPNorm < handle
    ...
    methods (Access = public)
        ...
        function obj = GripperProblemLevelSetIsoPerimetricPNorm(p,C,gJ,w)
            obj.init()
            obj.createMesh();
            ...
            vtuName = fullfile(fileLocation, sprintf('Topology_Gripper_isoperimeter_p%d_C%.2f_gJ%.2f_eta0.02_w%.2f_LevelSet',p,C,gJ,w));
            obj.designVariable.fun.print(vtuName);
            
            figure(2)
            set(gcf, 'Position', get(0, 'Screensize'));
            fileName1 = fullfile(fileLocation, sprintf('Monitoring_Gripper_isoperimeter_p%d_C%.2f_gJ%.2f_eta0.02_w%.2f_LevelSet.fig',p,C,gJ,w));
            fileName2 = fullfile(fileLocation, sprintf('Monitoring_Gripper_isoperimeter_p%d_C%.2f_gJ%.2f_eta0.02_w%.2f_LevelSet.png',p,C,gJ,w));
            savefig(fileName1);
