classdef testPlotting_Composite < testPlotting
    ...
    methods (Access = private)
        function coordsOk = checkCoordinates(obj,storedCoords)
            ...
            coordsOk = obj.checkComposedVar(obj.mesh.coord,boxMeshesCoords,storedCoords);            
        end
        ...
        function connecsOk = checkConnectivities(obj,storedConnecs)
            ...
            connecsOk = obj.checkComposedVar(obj.mesh.connec,boxMeshesConnecs,storedConnecs);                      
        end
    end
