classdef TopOptTests < handle & matlab.unittest.TestCase
    ...
    properties (TestParameter)
        compTestsNO = {'test_StressM1M2'} % ja no funcionaven
%         compTests = {'test_M1M2','test_bridge', 'test_bridge2', ...
...
%             }
       ...
       %  compTests = {'test_cantilever2'}
         compTests = {'testDualNestedInPrimal_WithSlerp'};
