classdef NewUnfittedIntegrationTests < handle & matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'UnfittedIntegration', 'Classic', 'Perimeter', 'Circle'}) % my eyes are circles
        ...
        function testPerimeterCircle(testCase, circleTests)
            ...
            test = NewUnfittedIntegrationTest(s);
    ...
    methods (Test, TestTags = {'UnfittedIntegration', 'Classic', 'Area', 'Circle'}) % my eyes are circles
