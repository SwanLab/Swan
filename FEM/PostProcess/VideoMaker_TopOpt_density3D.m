classdef  VideoMaker_TopOpt_density3D < VideoMaker_TopOpt
  properties
  ...
  methods (Access = private)
        function Make_video_density_field(obj,field2print,componentfield,output_video_name)
            ...
            file_path_in = fullfile(pwd,'FEM','PostProcess','Make_Video_density3D.tcl');
            ...
            fprintf(fid,'%s\n',['set arg5 "',obj.iterations_to_print,'"']);
