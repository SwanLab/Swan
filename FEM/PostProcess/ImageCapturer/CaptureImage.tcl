proc CaptureImage {pathFileVar outputFileVar} {
    ...
    GiD_Process Results ContourFill RegularizedDensity escape escape escape escape
    ...
    GiD_Process Results ContourFill RegularizedDensity RegularizedDensity Mescape
