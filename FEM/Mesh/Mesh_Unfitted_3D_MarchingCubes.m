classdef Mesh_Unfitted_3D_MarchingCubes < Mesh_Unfitted_3D & Mesh_Unfitted_MarchingCubes
    methods
        function obj = Mesh_Unfitted_3D_MarchingCubes(fitted_mesh,x_fitted,fitted_geom_interpolation)
