classdef Mesh_Unfitted_3D < Mesh_Unfitted
    methods
        ...
        function computeDvoluCut(obj)
            x1 = obj.unfitted_coord_iso_per_cell(:,1,1);   y1 = obj.unfitted_coord_iso_per_cell(:,1,2);   z1= obj.unfitted_coord_iso_per_cell(:,1,3);
            x2 = obj.unfitted_coord_iso_per_cell(:,2,1);   y2 = obj.unfitted_coord_iso_per_cell(:,2,2);   z2= obj.unfitted_coord_iso_per_cell(:,2,3);
            x3 = obj.unfitted_coord_iso_per_cell(:,3,1);   y3 = obj.unfitted_coord_iso_per_cell(:,3,2);   z3= obj.unfitted_coord_iso_per_cell(:,3,3);
            x4 = obj.unfitted_coord_iso_per_cell(:,4,1);   y4 = obj.unfitted_coord_iso_per_cell(:,4,2);   z4= obj.unfitted_coord_iso_per_cell(:,4,3);
        ...
        function assignUnfittedCutCoordIsoPerCell(obj,new_unfitted_coord_iso,new_interior_subcell_connec,lowerBound,upperBound)
            ...
            new_unfitted_coord_iso_z = new_unfitted_coord_iso(:,3);
            ...
            obj.unfitted_coord_iso_per_cell(lowerBound+1:upperBound,:,3) = new_unfitted_coord_iso_z(new_interior_subcell_connec);
        end
    end
end
