classdef Mesh_Unfitted_2D < Mesh_Unfitted
    methods (Access = public)
        ...
        function [P,active_nodes] = computeCutPoints_Iso(obj)
            ...
            gamma_1 = permute(obj.x_background(obj.background_mesh.connec(obj.background_cut_cells,:)),[2 3 1]);
        ...
        function [P,active_nodes] = computeCutPoints_Global(obj)
            index1 = permute(obj.background_mesh.connec(obj.background_cut_cells,:),[2 3 1]);
