classdef Mesh_Unfitted_Boundary < Mesh_Unfitted
    methods
        function [facets_coord_iso,facets_coord_global,facets_x_value,facets_connec] = computeSubcells(obj,background_cell_connec,cutPoints_iso,cutPoints_global)
            facets_coord_iso = cutPoints_iso;
            facets_coord_global = cutPoints_global;
            facets_x_value = zeros(1,size(cutPoints_iso,1));
            cell_x_value = obj.x_background(background_cell_connec)';
