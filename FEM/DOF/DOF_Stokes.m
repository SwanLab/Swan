classdef DOF_Stokes < DOF
    ...
    methods
        function obj = DOF_Stokes(filename,geometry,interpU,nFields) % Replace mesh for pdim
            nunkn_u = 2;
            nunkn_p = 1;
            obj.nunkn = [nunkn_u nunkn_p];
            [dirichlet_data,neumann_data,full_dirichlet_data] = Preprocess.getBC_fluids(filename,geometry,interpU);
