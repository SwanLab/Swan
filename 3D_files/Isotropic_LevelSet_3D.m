classdef Isotropic_LevelSet_3D < handle
    ...
    methods (Access = public)
        ...
        function obj = Isotropic_LevelSet_3D()
            obj.init()
            obj.createMesh();
            ...
            figure(2);
            saveas(gcf,'Monitoring_Isotropic_3D_LevelSet.fig');
            obj.designVariable.fun.print('fValues_Isotropic_3D_LevelSet');
    ...
    methods (Access = private)
        ...
        function createOptimizer(obj)
            ...
            %s.type           = '0';
            s.gif = false;
            s.gifName = 'Gif_Isotropic_3D_LevelSet';
            s.printing = true;
            s.printName = 'Results_Isotropic_3D_LevelSet';
